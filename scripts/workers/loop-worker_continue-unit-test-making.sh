...
# Configuration
RESULTS_FILE="continue-unit-test-results.md"
CONTEXT_FILE="continue-unit-test-context.md"
COMMAND_FILE=".claude/commands/continue-unit-test-fix.md"
DELAY_SECONDS=15
LOG_FILE="continue-unit-test.log"
