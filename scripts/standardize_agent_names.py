...
This will rename files in .claude/agents and folders in agenthub_main/agent-library/agents
"""
...
AGENT_LIBRARY_DIR = PROJECT_ROOT / "agenthub_main/agent-library/agents"
...
def rename_agent_library_folders():
    """Rename all folders in agenthub_main/agent-library/agents to kebab-case."""
