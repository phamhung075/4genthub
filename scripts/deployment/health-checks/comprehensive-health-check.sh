...
# =============================================================================
# Comprehensive Health Check Script - DhafnckMCP Production Deployment
# =============================================================================
...
check_keycloak_integration() {
    ...
    local oidc_config
    oidc_config=$(curl -s -o /dev/null -w "%{http_code}" --max-time "$TIMEOUT" "$KEYCLOAK_URL/realms/dhafnck/.well-known/openid_configuration" 2>/dev/null || echo "000")
