...
# =============================================================================
# DhafnckMCP Production Deployment Script
# =============================================================================
...
readonly DEPLOYMENT_LOG="/var/log/dhafnck-mcp-deployment.log"
...
main() {
    log_info "Starting DhafnckMCP deployment to ${ENVIRONMENT}"
    log_info "Deployment log: ${DEPLOYMENT_LOG}"
    
    # Create log file
    mkdir -p "$(dirname "$DEPLOYMENT_LOG")" 2>/dev/null || true
    touch "$DEPLOYMENT_LOG" 2>/dev/null || {
        DEPLOYMENT_LOG="/tmp/dhafnck-mcp-deployment.log"
