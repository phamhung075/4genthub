...
from dhafnck_mcp_main.src.tests.performance import setup_performance_logger
from dhafnck_mcp_main.src.tests.performance.benchmarks.comprehensive_benchmark_suite import Phase4ComprehensiveBenchmarkSuite
from dhafnck_mcp_main.src.tests.performance.benchmarks.response_size_tests import run_response_size_benchmark
from dhafnck_mcp_main.src.tests.performance.benchmarks.ai_comprehension_tests import run_ai_comprehension_benchmark
from dhafnck_mcp_main.src.tests.performance.benchmarks.load_testing_suite import run_load_testing_benchmark
...
async def run_comprehensive_benchmarks(output_dir: Path = None, ci_mode: bool = False):
    ...
    if ci_mode:
        ...
        from dhafnck_mcp_main.src.tests.performance import PERFORMANCE_CONFIG
