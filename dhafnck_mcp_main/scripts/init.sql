-- PostgreSQL Initialization Script for DhafnckMCP
...
-- CREATE DATABASE dhafnck_mcp_prod;
...
-- VALUES ('system', 'system@dhafnck.com', 'system', 'System', 'User', ARRAY['admin', 'system'], true)
...
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA mcp TO dhafnck_user;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA mcp TO dhafnck_user;
GRANT EXECUTE ON ALL FUNCTIONS IN SCHEMA mcp TO dhafnck_user;

GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO dhafnck_user;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO dhafnck_user;
GRANT EXECUTE ON ALL FUNCTIONS IN SCHEMA public TO dhafnck_user;
...
DO $$
BEGIN
    RAISE NOTICE 'Database initialization complete for dhafnck_mcp_prod';
    RAISE NOTICE 'Tables created: users, mcp_tokens, sessions, audit_log, projects, git_branches, tasks, subtasks, contexts';
    RAISE NOTICE 'User dhafnck_user has been granted all necessary permissions';
END $$;