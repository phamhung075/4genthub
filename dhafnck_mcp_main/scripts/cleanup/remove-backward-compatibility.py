#!/usr/bin/env python3
"""
Remove Backward Compatibility Code from DhafnckMCP Project
...
def main():
    ...
    parser.add_argument('--path', default='dhafnck_mcp_main/src',
                       help='Path to clean (default: dhafnck_mcp_main/src)')
