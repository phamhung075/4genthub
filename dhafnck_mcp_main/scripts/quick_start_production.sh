...
echo "=================================================="
echo "DhafnckMCP Production Quick Start"
...
echo "   - Keycloak Realm: ${KEYCLOAK_REALM:-dhafnck-mcp}"
...
for i in {1..30}; do
    if docker-compose exec postgres pg_isready -U ${DATABASE_USER:-dhafnck_user} -d ${DATABASE_NAME:-dhafnck_mcp_prod} &>/dev/null; then
...
echo "     python dhafnck_mcp_main/scripts/test_keycloak_mcp_integration.py"
echo ""
echo "  2. View logs:"
echo "     docker-compose logs -f mcp-server"
echo ""
echo "  3. Access PostgreSQL:"
echo "     docker-compose exec postgres psql -U ${DATABASE_USER:-dhafnck_user} -d ${DATABASE_NAME:-dhafnck_mcp_prod}"
echo ""
echo "  4. Stop services:"
echo "     docker-compose down"
echo ""
echo "For detailed setup instructions, see:"
echo "  dhafnck_mcp_main/docs/setup-guides/PRODUCTION_POSTGRESQL_KEYCLOAK_SETUP.md"
echo ""