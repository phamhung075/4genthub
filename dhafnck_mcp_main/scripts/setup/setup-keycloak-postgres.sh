...
# =============================================================================
# DhafnckMCP Setup Script - PostgreSQL Docker + Keycloak Cloud
# =============================================================================
...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}DhafnckMCP Production Setup${NC}"
...
cat > dhafnck_mcp_main/scripts/keycloak_setup.sql << 'EOF'
...
while [ $attempt -lt $max_attempts ]; do
    if docker-compose -f docker-compose.production.yml exec -T postgres pg_isready -U dhafnck_user -d dhafnck_mcp_prod &>/dev/null; then
...
echo "• PostgreSQL Database: dhafnck_mcp_prod"
echo "• PostgreSQL User: dhafnck_user"
...
echo
echo -e "${GREEN}✨ Your DhafnckMCP system is ready for production use!${NC}"