...
SUPABASE_FILES_TO_CHECK = [
    # Backend files
    "dhafnck_mcp_main/src/fastmcp/server/routes/auth_starlette.py",
    "dhafnck_mcp_main/src/fastmcp/server/routes/auth_keycloak_enhanced.py",
    "dhafnck_mcp_main/src/fastmcp/server/routes/task_routes.py",
    "dhafnck_mcp_main/src/fastmcp/server/manage_connection_tool.py",
    "dhafnck_mcp_main/src/fastmcp/task_management/infrastructure/database/database_config.py",
    "dhafnck_mcp_main/src/fastmcp/task_management/infrastructure/database/database_initializer.py",
    "dhafnck_mcp_main/src/fastmcp/task_management/infrastructure/database/connection_pool.py",
    "dhafnck_mcp_main/src/fastmcp/task_management/infrastructure/repositories/repository_factory.py",
    
    # Test files
    "dhafnck_mcp_main/src/tests/auth/test_email_service_integration.py",
    "dhafnck_mcp_main/src/tests/unit/auth/token_validator_test.py",
    "dhafnck_mcp_main/src/tests/unit/auth/middleware/dual_auth_middleware_test.py",
    
    # Frontend files
    "dhafnck-frontend/src/contexts/AuthContext.tsx",
    "dhafnck-frontend/src/services/api.ts",
]
...
FILES_TO_REMOVE = [
    ...
    "dhafnck_mcp_main/scripts/test_supabase_auth.py",
    "dhafnck_mcp_main/scripts/run_supabase_migration.py",
]
...
DATABASE_URL=postgresql://dhafnck_user:CHANGE_ME_SECURE_PASSWORD@postgres:5432/dhafnck_mcp_prod?sslmode=prefer
...
MCP_HOST=0.0.0.0
MCP_PORT=8001
MCP_SECRET_KEY=CHANGE_ME_GENERATE_SECURE_64_CHAR_STRING
