...
```json
{
  ...
  "context": {
    ...
    "files_to_modify": [
      {
        "action": "remove",
        "file": "/home/daihungpham/agentic-project/agenthub_main/src/fastmcp/server/routes/token_routes.py",
        "reason": "Starlette bridge layer - no longer needed"
      },
      {
        "action": "keep",
        "file": "/home/daihungpham/agentic-project/agenthub_main/src/fastmcp/server/routes/token_router.py", 
        "reason": "FastAPI implementation - primary route handler"
      },
      {
        "action": "update",
        "file": "/home/daihungpham/agentic-project/agenthub_main/src/fastmcp/server/mcp_entry_point.py",
    ...
    "current_services": [
      {
        ...
        "location": "/home/daihungpham/agentic-project/agenthub_main/src/fastmcp/auth/interface/"
      },
      {
        "name": "Supabase JWT", 
      ...
      },
      {
        ...
        "location": "/home/daihungpham/agentic-project/agenthub_main/src/fastmcp/auth/mcp_integration/"
      }
    ],
    "solution": "Create UnifiedJWTService handling all token types",
    "architecture_design": {
      "class_name": "UnifiedJWTService",
      "location": "/home/daihungpham/agentic-project/agenthub_main/src/fastmcp/auth/services/",
      "responsibilities": [
...
```json
{
  ...
  "context": {
    ...
    "key_test_files": [
      "/home/daihungpham/agentic-project/agenthub_main/src/tests/server/routes/token_routes_test.py",
      "/home/daihungpham/agentic-project/agenthub_main/src/tests/server/routes/token_router_test.py",
      "/home/daihungpham/agentic-project/agenthub-frontend/src/tests/pages/TokenManagement.test.tsx"
    ],
    "updates_needed": [
...
mcp__agenthub_http__call_agent(name_agent=task["agent_assignment"])
```
