# Claude Code & agenthub Agent System Integration Guide

## Overview

This guide explains how to integrate your advanced agenthub agent system (60+ specialized agents) with Claude Code's native agent system. Rather than replacing either system, we create a bridge architecture that allows both systems to work together seamlessly.
...
- Invoke your specialized agenthub agents
...
### 1. Verify agenthub System

Ensure your agenthub server is running:
...
1. **Connect to your agenthub agent**:
   ```
...
| Claude Code Agent | agenthub Agents | Use Cases |
|------------------|-------------------|-----------|
...
tools: mcp__agenthub_http__call_agent, mcp__agenthub_http__manage_task
model: sonnet
---

# Custom Workflow Agent

I bridge your specific workflow requirements with the agenthub system.
