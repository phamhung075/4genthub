...
compliance_agent = mcp__agenthub_http__call_agent(name_agent="@architecture_compliance_agent")
...
debugger = mcp__agenthub_http__call_agent(name_agent="debugger-agent")  # For controllers
coding = mcp__agenthub_http__call_agent(name_agent="coding-agent")      # For factory
tester = mcp__agenthub_http__call_agent(name_agent="test-orchestrator-agent")  # For tests
```
...
planning_agent = mcp__agenthub_http__call_agent(name_agent="task-planning-agent")
...
class SQLiteTaskRepository(BaseORMRepository, TaskRepository):
    ...
    def __init__(self):
        ...
        self.database_url = os.getenv('DATABASE_URL', 'postgresql://user:pass@localhost:5432/agenthub_dev')
...
compliance = mcp__agenthub_http__call_agent(name_agent="@architecture_compliance_agent")
# Check compliance_reports/compliance_report_20250828_154945.md

# Step 2: Fix controllers (14 HIGH violations)
debugger = mcp__agenthub_http__call_agent(name_agent="debugger-agent")
# Fix all 11 controller files using Phase 1 code above

# Step 3: Implement factory (7 broken factories)
coding = mcp__agenthub_http__call_agent(name_agent="coding-agent")
...
tester = mcp__agenthub_http__call_agent(name_agent="test-orchestrator-agent")
...
# 4. Complete task
mcp__agenthub_http__complete_task_with_update(
    task_id=task["id"],
