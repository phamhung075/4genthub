...
def inject_pending_tasks():
    ...
    pending_tasks = mcp__agenthub_http__manage_task(
        action="list",
        status="todo",
...
def get_next_work():
    ...
    next_item = mcp__agenthub_http__manage_task(
        action="next",
...
def handle_task_failure(task_id, error):
    ...
    alternative = mcp__agenthub_http__manage_task(
        action="next",
        skip_blocked=True
    )
...
def resume_project(project_id=None):
    ...
    # Get recent activity
    recent_tasks = mcp__agenthub_http__manage_task(
        action="list",
    ...
    current = mcp__agenthub_http__manage_task(
        action="list",
        status="in_progress"
    )
    
    upcoming = mcp__agenthub_http__manage_task(
        action="list",
        status="todo",
        limit=5
    )
