...
- **Test Agent Names**: `@@coding_agent`, `@test-orchestrator-agent`, `@security-auditor-agent`
...
✅ Parent: ["@@coding_agent", "@security-auditor-agent"]
   Child: [] (inherits both)
✅ Parent: ["@@coding_agent", "@security-auditor-agent"]
   Child: ["@test-orchestrator-agent"] (overrides)
✅ Mixed assignments: ["@@coding_agent", "user123"]
```
...
|--------------|----------|---------|--------|
| `"@@coding_agent"` | `["@@coding_agent"]` | `["@@coding_agent"]` | ✅ Pass |
| `"@@coding_agent,@test-agent"` | `["@@coding_agent", "@test-agent"]` | `["@@coding_agent", "@test-agent"]` | ✅ Pass |
| `"@@coding_agent, @test-agent"` | `["@@coding_agent", "@test-agent"]` | `["@@coding_agent", "@test-agent"]` | ✅ Pass |
| `""` | `[]` | `[]` | ✅ Pass |
| `"@@coding_agent,"` | `["@@coding_agent"]` | `["@@coding_agent"]` | ✅ Pass |
| `",@@coding_agent"` | `["@@coding_agent"]` | `["@@coding_agent"]` | ✅ Pass |
...
```
┌─────────────────┐
│  Parent Task    │ assignees: ["@@coding_agent", "@security-auditor-agent"]
│                 │
└──────┬──────────┘
       │ inherits (if empty)
