...
result = mcp__agenthub_http__call_agent(name_agent="@test-orchestrator-agent")
...
def get_agent_for_task(task_type):
    ...
    result = mcp__agenthub_http__call_agent(name_agent=f"@{agent_name}")
...
def process_multiple_agents(agent_names):
    ...
    for name in agent_names:
        result = mcp__agenthub_http__call_agent(name_agent=f"@{name}")
