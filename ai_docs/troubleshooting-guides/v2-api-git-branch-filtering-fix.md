...
### Backend Issue
**Location**: `agenthub_main/src/fastmcp/server/routes/user_scoped_task_routes.py` lines 105-208
...
### Frontend Issues
**Location 1**: `agenthub-frontend/src/services/apiV2.ts` lines 49-55
```typescript
...
**Location 2**: `agenthub-frontend/src/api.ts` line 144
```typescript
...
**File**: `agenthub-frontend/src/services/apiV2.ts`
...
**File**: `agenthub-frontend/src/api.ts`
...
### Backend Files
1. **Core Backend Fix**: `agenthub_main/src/fastmcp/server/routes/user_scoped_task_routes.py`
...
2. **Backend Test Coverage**: `agenthub_main/src/tests/integration/test_v2_api_git_branch_filtering_fix.py`
...
### Frontend Files (NEW!)
3. **Frontend V2 API Fix**: `agenthub-frontend/src/services/apiV2.ts`
...
4. **Frontend API Layer Fix**: `agenthub-frontend/src/api.ts`
   - Updated `listTasks()` to extract and pass `git_branch_id` to V2 API
   - Added comprehensive debug logging for troubleshooting
   - Preserved V1 API fallback functionality

5. **Frontend Test Coverage**: `agenthub_main/src/tests/integration/test_frontend_v2_api_branch_filtering_fix.py`
