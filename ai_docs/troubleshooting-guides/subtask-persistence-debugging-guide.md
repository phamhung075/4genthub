...
docker exec agenthub-postgres psql -U agenthub_user -d agenthub_test -c "SELECT version();"

# Verify table exists and is accessible
docker exec agenthub-postgres psql -U agenthub_user -d agenthub_test -c "\d task_subtasks"

# Test manual insert to verify table functionality
docker exec agenthub-postgres psql -U agenthub_user -d agenthub_test -c "
