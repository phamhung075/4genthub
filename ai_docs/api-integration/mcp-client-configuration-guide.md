...
```bash
export KEYCLOAK_REALM=agenthub
```
...
2. Select your realm (e.g., `agenthub`)
...
export KEYCLOAK_URL=http://localhost:8080
export MCP_SERVER_URL=http://localhost:8000
export KEYCLOAK_REALM=agenthub-dev
...
export KEYCLOAK_URL=https://keycloak.example.com
export MCP_SERVER_URL=https://api.example.com
export KEYCLOAK_REALM=agenthub-prod
...
export KEYCLOAK_REALM=agenthub-staging
