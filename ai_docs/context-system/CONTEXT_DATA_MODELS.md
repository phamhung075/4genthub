...
The agenthub Context System operates on a 4-tier hierarchical structure: **Global → Project → Branch → Task**. Each tier has specific data models, update patterns, and inheritance behaviors designed to optimize multi-agent collaboration and session persistence.
