...
These changes apply to the [local project level](/en/ai_docs/claude-code/settings)
...
### Output Styles vs. [Agents](/en/ai_docs/claude-code/sub-agents)
...
### Output Styles vs. [Custom Slash Commands](/en/ai_docs/claude-code/slash-commands)
