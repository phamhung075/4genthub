...
DATABASE_URL=postgresql://agenthub_user:agenthub_password@postgres:5432/agenthub
...
DATABASE_TYPE=postgresql
TEST_DATABASE_URL=postgresql://postgres:test@localhost:5432/agenthub_test
```
...
1. **Backup Existing Data**:
   ```bash
   # Export SQLite data
   sqlite3 agenthub.db .dump > backup.sql
   ```
...
psql -h localhost -p 5432 -U dev_user -d agenthub_dev
```
