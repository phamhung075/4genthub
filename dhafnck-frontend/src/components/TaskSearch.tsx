              ...
              {searchResults.tasks.length > 0 && (
                <div className="mb-3">
                  ...
                  {searchResults.tasks.map(task => (
                    <div
                      key={task.id}
                      className="px-2 py-2 hover:theme-context-section cursor-pointer rounded-md transition-colors"
                      onClick={() => handleTaskClick(task)}
                    >
                      <div className="flex items-start justify-between">
                        <div className="flex-1 min-w-0">
                          <p className="text-sm font-medium truncate">{task.title}</p>
                          <p className="text-xs text-text-secondary truncate">ID: {task.id}</p>
                        </div>
                    ...
                    >
                      <div className="flex items-start justify-between">
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs text-text-tertiary truncate">ID: {subtask.id}</p>
                        </div>
                        <div className="flex gap-1 ml-2">
