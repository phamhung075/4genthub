...
os.environ["4GENTHUB_AUTH_ENABLED"] = "false"
os.environ["4GENTHUB_DISABLE_CURSOR_TOOLS"] = "true"
...
def diagnose_environment():
    ...
    print(f"4GENTHUB_AUTH_ENABLED: {os.environ.get('4GENTHUB_AUTH_ENABLED', 'NOT SET')}")
    print(f"4GENTHUB_DISABLE_CURSOR_TOOLS: {os.environ.get('4GENTHUB_DISABLE_CURSOR_TOOLS', 'NOT SET')}")
    print()
...
def main():
    print("4GENTHUB MCP TOOLS DIAGNOSTIC")
    print("=" * 50)
