...
class AgentConsolidator:
    ...
    def update_call_agent_mappings(self):
        ...
        call_agent_path = Path("4genthub_main/src/fastmcp/task_management/application/use_cases/call_agent.py")
...
def main():
    ...
    parser.add_argument("--path", default="4genthub_main/agent-library", 
