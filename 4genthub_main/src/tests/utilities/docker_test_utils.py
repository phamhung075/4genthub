#!/usr/bin/env python3
"""
Docker Test Utilities for 4genthub E2E Testing
...
class DockerTestManager:
    ...
    async def build_test_image(self, force_rebuild: bool = False) -> Dict:
        """Build the 4genthub Docker image for testing"""
        try:
            dockerfile_path = self.project_root / "docker" / "Dockerfile"
            
            # Enhanced debugging information
            logger.info(f"🏗️ Building 4genthub test image...")
    ...
    async def start_test_container(self, 
                                 container_name: str = "4genthub-test",
