...
class TestContextDataPersistenceFix:
    ...
    def test_context_data_round_trip_persistence(self, global_context_repo, db_session):
        ...
        context_entity = GlobalContext(
            ...
            organization_name="4genthub Enterprise",
        ...
        assert org_settings.get("name") == "4genthub Enterprise", "Should preserve organization name"
...
if __name__ == "__main__":
    ...
    import sys
    sys.path.append('/home/daihungpham/__projects__/agentic-project/4genthub_main/src')
