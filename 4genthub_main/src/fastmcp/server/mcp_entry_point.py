...
class DebugLoggingMiddleware:
    ...
    def __init__(self, app):
        self.app = app
        self.logger = logging.getLogger("4genthub.debug.http")
...
def create_4genthub_server() -> FastMCP:
    """Create and configure the 4genthub server with all consolidated tools."""
    ...
    debug_logger = logging.getLogger("4genthub.debug.http")
    ...
    logger.info("Initializing 4genthub server with consolidated tools and authentication...")
    ...
    async def health_endpoint(request) -> JSONResponse:
        ...
        auth_status = os.environ.get("4GENTHUB_AUTH_ENABLED", "true")
    ...
    logger.info("4genthub server initialized successfully with authentication and connection management")
    return server
...
def main():
    ...
    try:
        ...
        logger.info("Starting 4genthub server with authentication...")
