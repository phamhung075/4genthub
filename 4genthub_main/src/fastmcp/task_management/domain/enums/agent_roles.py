...
This file contains all available agent roles from 4genthub_main/agent-library/agents.
...
class AgentRole(Enum):
    """Enumeration of all available agent roles - matches 4genthub_main/agent-library/agents"""
