...
This script generates Claude Code agent files from your 4genthub_http agent system.
...
4GENTHUB_URL = "http://localhost:8000"
...
COMMON_MCP_TOOLS = [
    "mcp__4genthub_http__call_agent",
...
def get_available_agents() -> List[str]:
    """Get list of available agents from 4genthub_http system."""
...
I am your bridge to the advanced {agent_name} in your 4genthub_http system. I provide seamless integration between Claude Code and your sophisticated agent orchestration platform.
...
```
mcp__4genthub_http__call_agent(name_agent="{agent_name}")
```
...
- I maintain compatibility with both Claude Code workflows and your 4genthub_http system
