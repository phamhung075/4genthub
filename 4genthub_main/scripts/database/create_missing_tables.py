...
from 4genthub_main.src.fastmcp.task_management.infrastructure.database.models import *
...
def create_missing_tables():
    ...
    try:
        ...
        from 4genthub_main.src.fastmcp.task_management.infrastructure.database.database_config import Base
