...
def check_docker_services():
    ...
    try:
        ...
        if 'postgres' in result.stdout or '4genthub-postgres' in result.stdout:
        ...
        if 'mcp-server' in result.stdout or '4genthub' in result.stdout:
...
def check_code_cleanliness():
    ...
    files_to_check = [
        '4genthub_main/src/fastmcp/server/http_server.py',
        '4genthub_main/src/fastmcp/server/mcp_entry_point.py',
...
async def main():
    ...
    if all_passed:
        ...
        print("2. Start frontend: cd 4genthub-frontend && npm start")
