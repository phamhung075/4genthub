...
def main():
    ...
    sqlite_paths = [
        "/home/daihungpham/agentic-project/4genthub_main/database/data/4genthub_test.db",
        "/data/4genthub.db",
        "./4genthub.db",
    ]
    ...
    pg_name = os.getenv("DATABASE_NAME", "4genthub")
    pg_user = os.getenv("DATABASE_USER", "4genthub_user")
