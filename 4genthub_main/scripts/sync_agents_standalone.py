...
AGENT_DEFINITIONS = {
    ...
    "task-planning-agent": {
        ...
        "tools": ["TodoWrite", "mcp__4genthub_http__manage_task", "mcp__4genthub_http__manage_subtask"],
        "specializations": [
...
## Integration Notes
This agent integrates with the 4genthub system and can be called via the MCP tools interface. It has access to the specified tools and follows the project's established patterns and conventions.
...
---
*Auto-generated from 4genthub agent definitions*
"""
