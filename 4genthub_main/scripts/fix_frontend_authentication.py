...
def solution_1_disable_auth():
    ...
    if env_file.exists():
        ...
        print("2. Change 4GENTHUB_AUTH_ENABLED=true to 4GENTHUB_AUTH_ENABLED=false")
        ...
        if "4GENTHUB_AUTH_ENABLED=true" in content:
            ...
            if confirm == 'y':
                ...
                # Apply fix
                new_content = content.replace("4GENTHUB_AUTH_ENABLED=true", "4GENTHUB_AUTH_ENABLED=false")
...
def solution_3_mvp_mode_fix():
    ...
    if env_file.exists():
        content = env_file.read_text()
        mvp_enabled = "4GENTHUB_MVP_MODE=true" in content
        auth_enabled = "4GENTHUB_AUTH_ENABLED=true" in content
    ...
    try:
        ...
        if 1 <= choice_num <= len(solutions):
            ...
            if success:
                ...
                print("   cd 4genthub_main && python -m fastmcp.server.mcp_entry_point --transport=streamable-http")
