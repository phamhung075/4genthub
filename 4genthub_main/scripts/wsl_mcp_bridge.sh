...
echo "📍 Python path: /home/daihungpham/agentic-project/4genthub_main/.venv/bin/python" >&2
...
echo "🚀 Starting 4genthub server..." >&2
exec /home/daihungpham/agentic-project/4genthub_main/.venv/bin/python -m fastmcp.server.mcp_entry_point 