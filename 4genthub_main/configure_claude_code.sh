#!/bin/bash
# Configure Claude Code to use 4genthub tools via bridge

echo "4genthub Claude Code Configuration Script"
echo "==========================================="
echo ""
echo "This script will help you configure Claude Code to connect to 4genthub tools."
echo ""
...
echo "1. Docker container is running: docker ps | grep 4genthub-server"
...
echo "2. Check MCP tools are available with: mcp__4genthub_http__health_check"
echo ""
