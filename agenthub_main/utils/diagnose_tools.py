...
def diagnose_environment():
    ...
    print(f"AGENTHUB_AUTH_ENABLED: {os.environ.get('AGENTHUB_AUTH_ENABLED', 'NOT SET')}")
    print(f"AGENTHUB_DISABLE_CURSOR_TOOLS: {os.environ.get('AGENTHUB_DISABLE_CURSOR_TOOLS', 'NOT SET')}")
    print()
