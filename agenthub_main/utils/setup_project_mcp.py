    ...
    try:
        ...
        if agenthub_path is None:
            ...
            if agenthub_path is None:
                ...
                print("   Please ensure agenthub_main is in the project or parent directory")
                return False
        ...
        if not venv_python.exists():
            ...
            print("   Please run: cd agenthub_main && python -m venv .venv && source .venv/bin/activate && pip install -e .")
            return False
