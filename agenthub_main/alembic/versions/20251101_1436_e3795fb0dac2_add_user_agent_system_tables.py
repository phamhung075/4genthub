...
def upgrade() -> None:
    ...
    op.create_index(
        op.f('idx_agent_templates_slug'),
        'agent_templates',
        ['slug']
    )
    op.create_index(
        op.f('idx_agent_templates_category'),
        'agent_templates',
        ['category']
    )
    ...
    op.create_table(
        ...
        sa.UniqueConstraint('user_id', 'template_id', name=op.f('user_agent_instances_user_template_key')),
        sa.UniqueConstraint('share_token', name=op.f('user_agent_instances_share_token_key')),
        sa.CheckConstraint(
            "visibility IN ('private', 'public')",
            name='check_visibility_values'
        ),
    )
    ...
    op.create_index(
        op.f('idx_user_agent_instances_user_id'),
        'user_agent_instances',
        ['user_id']
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.UniqueConstraint('instance_id', 'configuration_type', name=op.f('user_agent_configurations_md_instance_type_key')),
    )
