...
def analyze_by_range(data, coverage_range, top_n=50):
    ...
    for i, file_info in enumerate(top_files, 1):
        print(f"{i:<4} {file_info['file']:<45} {file_info['coverage']:<7.1f}% {file_info['missing']:<10} {file_info['statements']:<8}")

def main():
    parser = argparse.ArgumentParser(description="Analyze test coverage for strategic planning")
    ...
    parser.add_argument('--coverage-file', help='Coverage JSON file', default='coverage_final.json')
