...
class DDDLayerTracer:
    ...
    def analyze_file(self, filepath: Path) -> dict:
        ...
        return {
            ...
            "violations": self.check_violations(
                filepath, content, imports, layer_usage
            ),
        }
    ...
    def categorize_import(self, import_name: str, imports: dict):
        ...
        if (
            "controller" in import_name.lower()
            or "api_controller" in import_name.lower()
        ):
            imports["controller"].append(import_name)
        elif (
            "facade" in import_name.lower()
            or "application_facade" in import_name.lower()
        ):
            ...
            "repository" in import_name.lower() or "repositories" in import_name.lower()
        ):
    ...
    def detect_layer_usage(
        self, content: str, imports: dict
    ...
    def check_violations(
        self, filepath: Path, content: str, imports: dict, usage: dict
    ) -> list[LayerViolation]:
