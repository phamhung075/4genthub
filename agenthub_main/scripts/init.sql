...
-- VALUES ('system', 'system@agenthub.com', 'system', 'System', 'User', ARRAY['admin', 'system'], true)
...
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA mcp TO agenthub_user;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA mcp TO agenthub_user;
GRANT EXECUTE ON ALL FUNCTIONS IN SCHEMA mcp TO agenthub_user;
...
GRANT EXECUTE ON ALL FUNCTIONS IN SCHEMA public TO agenthub_user;
