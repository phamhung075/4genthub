    ...
    try:
        ...
        with engine.connect() as conn:
            ...
            if missing_columns:
                ...
                print(
                    "💡 Run the migration script to fix: 004_fix_user_isolation_missing_columns.sql"
                )
                return False
            else:
    ...
    try:
        ...
        with engine.connect() as conn:
            ...
            try:
                ...
                conn.execute(
                    text("ALTER TABLE task_assignees ADD COLUMN user_id VARCHAR(255)")
                )
            ...
            try:
                conn.execute(
                    text("ALTER TABLE task_labels ADD COLUMN user_id VARCHAR(255)")
                )
            ...
            try:
                conn.execute(
                    text("ALTER TABLE task_subtasks ADD COLUMN user_id VARCHAR(255)")
                )
