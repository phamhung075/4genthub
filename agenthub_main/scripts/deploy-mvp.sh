...
echo "🚀 agenthub MVP Deployment & Launch"
echo "======================================"
...
docker build -t agenthub/mcp-server:test --target runtime .

# Test the image
echo "🧪 Testing Docker image..."
docker run --rm agenthub/mcp-server:test python -c "
from src.fastmcp.server.mcp_entry_point import create_agenthub_server
...
- Backend: Docker image agenthub/mcp-server:$VERSION
...
🚀 agenthub MVP Successfully Deployed!
======================================

🌐 Frontend: Available on Vercel
🐳 Backend: agenthub/mcp-server:$VERSION
...
🔗 Quick Start:
   docker run -p 8000:8000 agenthub/mcp-server:$VERSION
...
# agenthub MVP Deployment Summary
...
### Access Information:
- **Docker Image**: \`agenthub/mcp-server:$VERSION\`
