...
echo ""
echo "2. General Tab:"
echo "   Name: agenthub Database"
echo ""
echo "3. Connection Tab:"
echo "   Host: postgres"
echo "   Port: 5432"
echo "   Database: agenthub_prod"
echo "   Username: agenthub_user"
...
echo "========================================="
docker exec agenthub-postgres psql -U agenthub_user -d agenthub_prod -c "SELECT 'Database connection successful!' as status;" 2>/dev/null
