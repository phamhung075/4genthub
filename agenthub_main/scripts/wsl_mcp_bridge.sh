...
echo "📍 Python path: /home/daihungpham/agentic-project/agenthub_main/.venv/bin/python" >&2
...
echo "🚀 Starting agenthub server..." >&2
exec /home/daihungpham/agentic-project/agenthub_main/.venv/bin/python -m fastmcp.server.mcp_entry_point 