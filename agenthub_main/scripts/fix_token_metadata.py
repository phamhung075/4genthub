...
def main():
    ...
    sqlite_paths = [
        "/home/daihungpham/agentic-project/agenthub_main/database/data/agenthub_test.db",
        "/data/agenthub.db",
        "./agenthub.db",
    ]
    ...
    pg_name = os.getenv("DATABASE_NAME", "agenthub")
    pg_user = os.getenv("DATABASE_USER", "agenthub_user")
