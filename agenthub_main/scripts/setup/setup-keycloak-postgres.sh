...
# =============================================================================
# agenthub Setup Script - PostgreSQL Docker + Keycloak Cloud
# =============================================================================
...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}agenthub Production Setup${NC}"
...
cat > agenthub_main/scripts/keycloak_setup.sql << 'EOF'
...
while [ $attempt -lt $max_attempts ]; do
    if docker-compose -f docker-compose.production.yml exec -T postgres pg_isready -U agenthub_user -d agenthub_prod &>/dev/null; then
...
echo "• PostgreSQL Database: agenthub_prod"
echo "• PostgreSQL User: agenthub_user"
...
echo
echo -e "${GREEN}✨ Your agenthub system is ready for production use!${NC}"