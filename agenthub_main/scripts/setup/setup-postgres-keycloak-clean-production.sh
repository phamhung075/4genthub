...
# ==============================================================================
# Clean Production Setup for agenthub
...
DB_NAME="${DATABASE_NAME:-agenthub_prod}"
DB_USER="${DATABASE_USER:-agenthub_user}"
...
cleanup_old_containers() {
    ...
    if [ "$1" == "--clean-volumes" ]; then
        ...
        docker volume rm agenthub_logs 2>/dev/null || true
        docker volume rm agenthub_pgadmin_data 2>/dev/null || true
    fi
...
try:
    ...
    config.database_name = os.getenv("DATABASE_NAME", "agenthub_prod")
    config.database_user = os.getenv("DATABASE_USER", "agenthub_user")
...
main() {
    ...
    print_header "agenthub Clean Production Setup"
