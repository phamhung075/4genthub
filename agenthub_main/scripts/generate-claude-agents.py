...
This script generates Claude Code agent files from your agenthub_http agent system.
...
```
mcp__agenthub_http__call_agent(name_agent="{agent_name}")
```
...
- I maintain compatibility with both Claude Code workflows and your agenthub_http system
