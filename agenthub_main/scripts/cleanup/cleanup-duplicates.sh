...
rm -f agenthub_main/src/fastmcp/auth/keycloak_auth_clean.py
rm -f agenthub_main/src/fastmcp/auth/keycloak_auth_final.py
rm -f agenthub_main/src/fastmcp/auth/keycloak_auth_production.py
rm -f agenthub_main/src/fastmcp/auth/keycloak_auth_unified.py

# Remove duplicate MCP server files
echo "Removing duplicate MCP server files..."
rm -f agenthub_main/src/mcp_http_server_clean.py
rm -f agenthub_main/src/mcp_http_server_final.py
rm -f agenthub_main/src/mcp_http_server_postgres_keycloak.py
rm -f agenthub_main/src/mcp_http_server_production*.py
rm -f agenthub_main/src/mcp_http_server_unified.py
rm -f agenthub_main/src/mcp_server_*.py
rm -f mcp_http_server_clean.py

# Remove duplicate database config files
echo "Removing duplicate database config files..."
rm -f agenthub_main/src/fastmcp/task_management/infrastructure/database/database_config_clean.py
rm -f agenthub_main/src/fastmcp/task_management/infrastructure/database/database_config_postgres.py
rm -f agenthub_main/src/fastmcp/task_management/infrastructure/database/database_config_production.py
...
rm -f agenthub_main/test_keycloak_mcp.py
