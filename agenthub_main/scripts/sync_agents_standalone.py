...
## Integration Notes
This agent integrates with the agenthub system and can be called via the MCP tools interface. It has access to the specified tools and follows the project's established patterns and conventions.
