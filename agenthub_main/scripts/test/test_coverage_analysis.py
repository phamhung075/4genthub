...
def analyze_test_coverage():
    ...
    for source_file in source_files:
        ...
        if str(expected_test_path) in test_file_paths:
            ...
            alt_test_paths = [
                expected_test_path.parent
                / (expected_test_path.stem.replace("_test", "_tests") + ".py"),
...
def prioritize_missing_tests(missing_tests: list[dict]) -> dict[str, list[dict]]:
    ...
    for missing in missing_tests:
        ...
        if layer in ["domain", "application"] and (
            ...
            or "entity" in file_name
            or "use_case" in file_name
            or "facade" in file_name
            or "repository" in file_name
        ):
