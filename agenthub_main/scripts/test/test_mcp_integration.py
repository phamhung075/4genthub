...
def test_mcp_server():
    ...
    try:
        ...
        print(
            "✅ ConsolidatedMCPTools imported successfully (using DDDCompliantMCPTools)"
        )
    ...
    try:
        ...
        if test_project.get("success"):
            print(
                f"✅ Created test project: {test_project.get('project', {}).get('name')}"
            )
            ...
            if branch_result.get("success"):
                print(
                    f"✅ Created branch: {branch_result.get('git_branch', {}).get('name')}"
                )
                ...
                if task_result.get("success"):
                    print(
                        f"✅ Created task: {task_result.get('task', {}).get('title')}"
                    )
