...
def check_docker_services():
    ...
    try:
        ...
        if 'postgres' in result.stdout or 'agenthub-postgres' in result.stdout:
        ...
        if 'mcp-server' in result.stdout or 'agenthub' in result.stdout:
...
def check_code_cleanliness():
    ...
    files_to_check = [
        'agenthub_main/src/fastmcp/server/http_server.py',
        'agenthub_main/src/fastmcp/server/mcp_entry_point.py',
...
async def main():
    ...
    if all_passed:
        ...
        print("2. Start frontend: cd agenthub-frontend && npm start")
