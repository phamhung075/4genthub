...
class AgentConsolidator:
    ...
    def update_call_agent_mappings(self):
        ...
        call_agent_path = Path("agenthub_main/src/fastmcp/task_management/application/use_cases/call_agent.py")
...
def main():
    ...
    parser.add_argument("--path", default="agenthub_main/agent-library", 
