...
class MockUnifiedContextService:
    ...
    def __init__(self):
        ...
        self._contexts = {}
        logger.warning(
            "Using MockUnifiedContextService - context operations will not persist"
        )
    ...
    def list_contexts(
        self, level: str | None = None, filters: dict[str, Any | None] = None
    ) -> list[dict[str, Any]]:
    ...
    def add_insight(
        self, level: str, context_id: str, insight: dict[str, Any]
    ) -> dict[str, Any]:
    ...
    def add_progress(
        self, level: str, context_id: str, progress: dict[str, Any]
    ) -> dict[str, Any]:
    ...
    def validate_hierarchy(
        self, task_id: str, branch_id: str | None = None, project_id: str | None = None
    ) -> dict[str, Any]:
        """Validate context hierarchy"""
        # In mock implementation, always return valid
        return {"valid": True, "message": "Mock hierarchy validation - always valid"}

    def get_hierarchy_chain(self, level: str, context_id: str) -> list[dict[str, Any]]:
