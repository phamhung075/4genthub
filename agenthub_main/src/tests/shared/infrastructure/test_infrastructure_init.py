...
class TestSharedInfrastructureInit:
    ...
    def test_messaging_imports(self):
        ...
        from fastmcp.shared.infrastructure.messaging import (
            EventPriority as DirectEventPriority,
        )
    ...
    def test_function_imports(self):
        ...
        from fastmcp.shared.infrastructure.messaging import get_event_bus as direct_get
        from fastmcp.shared.infrastructure.messaging import set_event_bus as direct_set
