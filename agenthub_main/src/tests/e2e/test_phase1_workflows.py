...
class TestPhase1TaskCRUDOperations:
    ...
    def test_create_task_response_structure(
        self, mcp_tools, project_with_branch, mock_auth
    ):
    ...
    def test_get_task_default_no_context(
        ...
        result = mcp_tools._task_controller.manage_task_sync(
            action="get", task_id=task_id, user_id=mock_auth
        )
    ...
    def test_update_task_maintains_structure(
        self, mcp_tools, project_with_branch, mock_auth
    ):
    ...
    def test_list_tasks_response_structure(
        ...
        # List tasks
        result = mcp_tools._task_controller.manage_task_sync(
            action="list", git_branch_id=git_branch_id, user_id=mock_auth
        )
    ...
    def test_delete_task_cascade_behavior(
        self, mcp_tools, project_with_branch, mock_auth
    ):
        ...
        delete_result = mcp_tools._task_controller.manage_task_sync(
            action="delete", task_id=task_id, user_id=mock_auth
        )
...
class TestPhase1SubtaskOperations:
    ...
    def test_create_subtask_updates_parent_array(
        self, mcp_tools, project_with_branch, mock_auth
    ):
    ...
    def test_list_subtasks_response_structure(
        self, mcp_tools, project_with_branch, mock_auth
    ):
        ...
        result = mcp_tools._subtask_controller.manage_subtask(
            action="list", task_id=task_id, user_id=mock_auth
        )
    ...
    def test_complete_subtask_updates_parent_context(
        self, mcp_tools, project_with_branch, mock_auth
    ):
...
class TestPhase1ContextLoading:
    ...
    def test_include_context_false_excludes_context(
        self, mcp_tools, project_with_branch, mock_auth
    ):
        ...
        result = mcp_tools._task_controller.manage_task_sync(
            action="get", task_id=task_id, include_context=False, user_id=mock_auth
        )
    ...
    def test_include_context_true_includes_context(
        self, mcp_tools, project_with_branch, mock_auth
    ):
        ...
        result = mcp_tools._task_controller.manage_task_sync(
            action="get", task_id=task_id, include_context=True, user_id=mock_auth
        )
...
class TestPhase1ArrayBasedCountLogic:
    ...
    def test_task_with_multiple_subtasks(
        self, mcp_tools, project_with_branch, mock_auth
    ):
    ...
    def test_empty_arrays_handled_correctly(
        self, mcp_tools, project_with_branch, mock_auth
    ):
...
class TestPhase1NoRegressions:
    ...
    def test_existing_functionality_still_works(
        ...
        update_result = mcp_tools._task_controller.manage_task_sync(
            action="update", task_id=task_id, status="in_progress", user_id=mock_auth
        )
    ...
    def test_task_dependencies_resolve_properly(
        self, mcp_tools, project_with_branch, mock_auth
    ):
