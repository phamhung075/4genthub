...
class TestUserRepository:
    ...
    # Test save method
    @pytest.mark.asyncio
    async def test_save_new_user_without_id(
        self, repository, mock_session, sample_user
    ):
        ...
        with patch(
            "fastmcp.auth.infrastructure.database.models.User.from_domain",
    ...
    @pytest.mark.asyncio
    async def test_save_update_existing_user(
        self, repository, mock_session, sample_user, sample_db_user
    ):
    ...
    async def test_get_by_id_found(self, repository, mock_session, sample_db_user):
        ...
        # Arrange
        sample_db_user.to_domain = Mock(
            return_value=DomainUser(
                id="test-user-id",
                email="test@example.com",
                username="testuser",
                password_hash="hashed_password",
    ...
    async def test_get_by_username_found(
        self, repository, mock_session, sample_db_user
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_by_reset_token_found(
        self, repository, mock_session, sample_db_user
    ):
    ...
    def test_find_by_id_with_none_values(
        self, repository, mock_session, sample_db_user
    ):
    ...
    def test_find_by_id_with_string_enums(
        self, repository, mock_session, sample_db_user
    ):
