...
class TestCheckConnectionHealthUseCase(unittest.TestCase):
    ...
    def test_execute_with_specific_connection_id_found(self):
        ...
        # Verify interactions
        self.mock_connection_repository.find_by_id.assert_called_once_with(
            connection_id
        )
    ...
    def test_execute_with_specific_connection_id_not_found(self):
        ...
        self.assertIn(
            f"Connection {connection_id} not found", response.connection_info["error"]
        )
    ...
    def test_execute_handles_repository_exception(self):
        ...
        self.mock_connection_repository.find_by_id.side_effect = Exception(
            "Database error"
        )
    ...
    @patch(
        "fastmcp.connection_management.application.use_cases.check_connection_health.logger"
    )
