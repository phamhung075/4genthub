...
class TestGetServerStatusUseCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_server.name = "agenthub Server"
    ...
    def test_execute_with_existing_server(self):
        ...
        # Verify server info
        self.assertEqual(response.server_info["name"], "agenthub Server")
    ...
    def test_execute_creates_server_when_none_exists(self):
        ...
        self.mock_server_repository.create_server.assert_called_once_with(
            ...
            authentication={"enabled": True, "type": "JWT", "provider": "Supabase"},
            task_management={
                "total_tasks": 50,
                "active_projects": 3,
                "completed_tasks": 30,
    ...
    @patch(
        "fastmcp.connection_management.application.use_cases.get_server_status.logger"
    )
