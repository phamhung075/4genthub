...
class TestProjectMCPController:
    ...
    def mock_facade_service(self):
        ...
        if (
            hasattr(FacadeService, "_mock_name")
            or hasattr(FacadeService, "_spec_class")
            or isinstance(FacadeService, type(MagicMock()))
        ):
            mock_service = Mock()
        else:
        ...
        if (
            hasattr(ProjectApplicationFacade, "_mock_name")
            or hasattr(ProjectApplicationFacade, "_spec_class")
            or isinstance(ProjectApplicationFacade, type(MagicMock()))
        ):
            mock_facade = Mock()
        else:
    ...
    def mock_authentication(self, sample_user_id):
        ...
        with (
            patch(
                "fastmcp.task_management.interface.mcp_controllers.project_mcp_controller.project_mcp_controller.get_authenticated_user_id"
            ) as mock_auth,
            patch(
                "fastmcp.task_management.interface.mcp_controllers.project_mcp_controller.project_mcp_controller.log_authentication_details"
            ) as mock_log,
        ):
    ...
    def test_create_project_missing_name(
        self, controller, mock_authentication, mock_permissions
    ):
        ...
        result = controller.manage_project(
            action="create", description="Project without name"
        )
    ...
    def test_create_project_duplicate_name(
        ...
        assert (
            "duplicate" in error_text.lower() or "already exists" in error_text.lower()
        )
    ...
    def test_get_project_by_id_success(
        ...
        result = controller.manage_project(
            action="get", project_id=sample_project_data["project_id"]
        )
    ...
    def test_get_project_by_name_success(
        ...
        result = controller.manage_project(
            action="get", name=sample_project_data["name"]
        )
    ...
    def test_get_project_not_found(
        self, controller, mock_facade_service, mock_authentication, mock_permissions
    ):
        ...
        result = controller.manage_project(action="get", project_id="non-existent-id")
    ...
    def test_get_project_missing_identifier(
        self, controller, mock_authentication, mock_permissions
    ):
    ...
    def test_update_project_missing_project_id(
        self, controller, mock_authentication, mock_permissions
    ):
        """Test project update without project_id."""
        result = controller.manage_project(action="update", name="Updated Name")
    ...
    def test_project_health_check_success(
        self,
        controller,
        mock_facade_service,
        sample_project_data,
        ...
        result = controller.manage_project(
            action="project_health_check", project_id=sample_project_data["project_id"]
        )
    ...
    def test_project_health_check_unhealthy(
        self,
        controller,
        mock_facade_service,
        sample_project_data,
    ...
    def test_cleanup_obsolete_success(
        self,
        controller,
        mock_facade_service,
        sample_project_data,
        ...
        result = controller.manage_project(
            action="cleanup_obsolete", project_id=sample_project_data["project_id"]
        )
    ...
    def test_cleanup_obsolete_with_force(
        self,
        controller,
        mock_facade_service,
        sample_project_data,
    ...
    def test_validate_integrity_success(
        ...
        result = controller.manage_project(
            action="validate_integrity", project_id=sample_project_data["project_id"]
        )
    ...
    def test_validate_integrity_with_issues(
        self,
        controller,
        mock_facade_service,
        sample_project_data,
    ...
    def test_rebalance_agents_success(
        self,
        controller,
        mock_facade_service,
        sample_project_data,
        ...
        result = controller.manage_project(
            action="rebalance_agents", project_id=sample_project_data["project_id"]
        )
    ...
    def test_unauthenticated_request(self, controller):
        ...
        with patch(
            ...
            mock_auth.side_effect = UserAuthenticationRequiredError(
    ...
    def test_insufficient_permissions(self, controller, mock_authentication):
        ...
        with patch(
            ...
            result = controller.manage_project(action="create", name="Test Project")
    ...
    def test_valid_project_names(
        ...
        result = controller.manage_project(
            action="create", name=project_name, description="Test project"
        )
    ...
    def test_invalid_project_names(
        self, controller, invalid_name, mock_authentication, mock_permissions
    ):
        """Test project creation with invalid project names."""
        result = controller.manage_project(
            action="create", name=invalid_name, description="Test project"
        )
    ...
    def test_large_project_data_handling(
        self, controller, mock_facade_service, mock_authentication, mock_permissions
    ):
        ...
        result = controller.manage_project(
            action="create", name="Large Project", description=large_description
        )

        assert result["success"] is True

    def test_special_characters_in_project_data(
        self, controller, mock_facade_service, mock_authentication, mock_permissions
    ):
        ...
        result = controller.manage_project(
            action="create", name=project_name, description=project_description
        )
