...
class TestInitDatabase:
    ...
    @patch(
        "fastmcp.task_management.infrastructure.database.init_database.get_db_config"
    )
    ...
    def test_init_database_failure(self, mock_logger, mock_get_db_config):
        ...
        mock_logger.error.assert_called_with(
            "Failed to initialize database: Database config error"
        )
    ...
    def test_init_database_create_tables_failure(self, mock_logger, mock_get_db_config):
        ...
        mock_logger.error.assert_called_with(
            "Failed to initialize database: Table creation failed"
        )
