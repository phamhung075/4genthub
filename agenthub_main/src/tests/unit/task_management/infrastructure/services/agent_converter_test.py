...
class TestAgentConverter:
    ...
    def test_convert_simplified_agent_to_entity_coding_agent(self, converter):
        ...
        assert set(["python", "javascript", "typescript", "html", "css"]).issubset(
            set(result.preferred_languages)
        )
    ...
    def test_extract_agent_details_strips_at_symbol(self, converter):
        ...
        capabilities, specializations, languages = converter._extract_agent_details(
            "@coding-agent"
        )
    ...
    def test_extract_agent_details_handles_underscores(self, converter):
        ...
        capabilities1, spec1, lang1 = converter._extract_agent_details(
            "test-orchestrator-agent"
        )
        capabilities2, spec2, lang2 = converter._extract_agent_details(
    ...
    def test_update_agent_assignments(self, converter):
        ...
        agent_entities = {"agent1": agent1, "agent2": agent2}
    ...
    def test_agent_timestamp_fields(self, converter):
        ...
        result = converter.convert_simplified_agent_to_entity(
            agent_data, "project_time"
        )
