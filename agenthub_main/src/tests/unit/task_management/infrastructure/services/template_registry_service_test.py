...
class TestTemplateRegistryService:
    ...
    async def test_get_template_requires_connection(self):
        ...
        service._get_connection = Mock(
            side_effect=RuntimeError("PostgreSQL connection implementation required")
        )
    ...
    async def test_update_template_requires_connection(self):
        ...
        result = await service.update_template(
            template_id="test_id",
            updates={"name": "Updated Template", "description": "Updated description"},
        )
    ...
    async def test_calculate_template_score(self):
        ...
        task_context = {"task_type": "test_type"}
    ...
    async def test_get_suggestion_reason(self):
        ...
        template = {"template_type": "test_type", "agent_compatibility": "all"}
