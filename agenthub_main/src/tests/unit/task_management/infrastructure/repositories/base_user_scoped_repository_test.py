...
class TestBaseUserScopedRepository:
    ...
    def test_initialization_system_mode(self, mock_session):
        ...
        with patch(
            "fastmcp.task_management.infrastructure.repositories.base_user_scoped_repository.logger"
        ):
    ...
    def test_ensure_user_ownership_no_user_id(self, repository):
        ...
        with patch(
            ...
            assert (
                "does not have user_id attribute" in mock_logger.warning.call_args[0][0]
            )
