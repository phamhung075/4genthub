...
class TestORMGitBranchRepository:
    ...
    def setup_mock_queries(self, mock_session, project_query_mock):
        ...
        def query_side_effect(*args):
            ...
            if len(args) > 1 or (hasattr(model, '__class__') and 'Label' in str(model.__class__)):
    ...
    async def test_get_branch_statistics(self, repository, mock_session):
        ...
        def query_side_effect(*args):
            ...
            if len(args) > 1 or (len(args) == 1 and hasattr(args[0], '__class__') and 'Label' in str(args[0].__class__)):
