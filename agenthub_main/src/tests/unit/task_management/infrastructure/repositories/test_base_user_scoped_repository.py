...
class ConcreteUserScopedRepository(BaseUserScopedRepository):
    ...
    def count(self) -> int:
        ...
        query = (
            f"SELECT COUNT(*) FROM {self.table_name} WHERE user_id = '{self.user_id}'"
        )
        self.session.execute_query(query)
...
class TestBaseUserScopedRepository:
    ...
    def test_apply_user_filter_handles_complex_queries(self, repository, user_id):
        ...
        assert (
            "AND t.user_id = " in filtered_query or "AND user_id = " in filtered_query
        )
        assert user_id in filtered_query
    ...
    def test_create_prevents_overriding_user_id(
        self, repository, mock_session, user_id, other_user_id
    ):
    ...
    def test_update_prevents_changing_user_id(
        self, repository, mock_session, user_id, other_user_id
    ):
    ...
    def test_user_cannot_access_other_user_data(
        self, mock_session, user_id, other_user_id
    ):
    ...
    def test_batch_operations_maintain_user_isolation(
