...
class TestBranchStatisticsService:
    ...
    def test_on_task_created_updates_statistics(
        self, service, mock_task_repository, mock_git_branch_repository
    ):
        ...
        mock_git_branch_repository.update.assert_called_once_with(
            branch_id,
            {"task_count": 4, "completed_task_count": 1, "progress_percentage": 25.0},
        )

    def test_on_task_created_without_branch_id_does_nothing(
    ...
    def test_on_task_updated_same_branch_status_change(
        self, service, mock_task_repository, mock_git_branch_repository
    ):
    ...
    def test_on_task_updated_branch_change(
        self, service, mock_task_repository, mock_git_branch_repository
    ):
        ...
        old_branch_tasks = [MockTask("task1", "done"), MockTask("task2", "todo")]
    ...
    def test_on_task_deleted(
        ...
        mock_tasks = [MockTask("task1", "done"), MockTask("task3", "blocked")]
        mock_task_repository.find_by_git_branch_id.return_value = mock_tasks
        ...
        mock_git_branch_repository.update.assert_called_once_with(
            branch_id,
            {"task_count": 2, "completed_task_count": 1, "progress_percentage": 50.0},
        )

    def test_recalculate_branch_statistics(
        self, service, mock_task_repository, mock_git_branch_repository
    ):
    ...
    def test_recalculate_branch_statistics_empty_branch(
        self, service, mock_task_repository, mock_git_branch_repository
    ):
    ...
    def test_recalculate_branch_statistics_branch_not_found(
        self, service, mock_task_repository, mock_git_branch_repository
    ):
    ...
    def test_recalculate_all_branches_with_project_id(
        self, service, mock_task_repository, mock_git_branch_repository
    ):
        ...
        mock_branches = [MockBranch("branch1"), MockBranch("branch2")]
    ...
    def test_recalculate_all_branches_without_project_id(
        self, service, mock_task_repository, mock_git_branch_repository
    ):
    ...
    def test_recalculate_all_branches_handles_exceptions(
        self, service, mock_task_repository, mock_git_branch_repository
    ):
    ...
    def test_get_branch_statistics_branch_not_found(
        self, service, mock_git_branch_repository
    ):
    ...
    def test_error_logging_on_task_created(
        self, mock_logger, service, mock_task_repository
    ):
        ...
        assert (
            "Failed to update branch statistics on task creation"
            in mock_logger.error.call_args[0][0]
        )

    @patch("fastmcp.task_management.domain.services.branch_statistics_service.logger")
    def test_error_logging_on_task_updated(
        self, mock_logger, service, mock_task_repository
    ):
    ...
    @patch("fastmcp.task_management.domain.services.branch_statistics_service.logger")
    def test_warning_when_branch_not_found_during_update(
        self, mock_logger, service, mock_task_repository, mock_git_branch_repository
    ):
        ...
        assert (
            f"Branch {branch_id} not found for statistics update"
