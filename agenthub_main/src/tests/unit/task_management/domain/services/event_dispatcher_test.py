...
class TestEventDispatcherGlobalFunctions:
    ...
    @patch('fastmcp.task_management.domain.services.event_dispatcher._event_dispatcher', None)
    ...
    @patch('fastmcp.task_management.domain.services.event_dispatcher.get_event_dispatcher')
