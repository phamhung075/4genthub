...
class TestTemplateDomainService:
    ...
    def test_validate_template_invalid_variable_characters(self, service, mock_template):
    ...
    def test_calculate_template_score_agent_wildcard(self, service, mock_template):
        ...
        task_context = {}
        score = service.calculate_template_score(mock_template, task_context, "any_agent")
