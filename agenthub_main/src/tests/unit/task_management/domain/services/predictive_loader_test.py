...
class TestSessionManagement:
    ...
    def test_record_tool_usage_no_session(self, predictive_loader):
        ...
        with patch('logging.Logger.warning') as mock_warning:
            ...
            mock_warning.assert_called_with("No active session for tool usage recording")
    ...
    def test_record_context_access_no_session(self, predictive_loader):
        ...
        with patch('logging.Logger.warning') as mock_warning:
            ...
            mock_warning.assert_called_with("No active session for context access recording")
...
class TestPredictions:
    ...
    def test_predict_next_contexts_no_patterns(self, predictive_loader, sample_current_context):
    ...
    def test_predict_from_tool_sequence(self, predictive_loader, sample_current_context):
        ...
        assert "predicted_task" in result.predicted_contexts  # Tool maps to task context
    ...
    def test_predict_from_context_transitions(self, predictive_loader):
        ...
        predictive_loader.context_transitions[("ctx-123", "ctx-124")] = 10  # Higher frequency
        predictive_loader.context_transitions[("ctx-123", "ctx-125")] = 8   # Also above threshold
        ...
        assert result.confidence_scores["ctx-124"] >= result.confidence_scores["ctx-125"]
        assert "context_transition:ctx-123" in result.patterns_used
    
    def test_predict_from_time_patterns(self, predictive_loader, sample_current_context):
    ...
    def test_predict_from_session_history(self, predictive_loader, sample_current_context):
...
class TestEdgeCases:
    ...
    def test_predict_with_empty_recent_tools(self, predictive_loader, sample_current_context):
