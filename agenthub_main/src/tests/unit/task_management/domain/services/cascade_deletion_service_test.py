...
class TestTaskCascadeDeletion(TestCascadeDeletionService):
    ...
    def test_delete_task_only_success(self, service, mock_repositories, mock_task):
        ...
        with patch(
            "fastmcp.task_management.domain.services.event_dispatcher.dispatch_domain_event"
        ):
        ...
        mock_repositories[
            "subtask_repository"
        ].delete_by_parent_task_id.assert_not_called()
    ...
    def test_delete_task_with_subtasks(self, service, mock_repositories, mock_task):
        ...
        mock_repositories[
            "subtask_repository"
        ].delete_by_parent_task_id.return_value = True

        with patch(
            "fastmcp.task_management.domain.services.event_dispatcher.dispatch_domain_event"
        ):
            result = service.delete_task_cascade(
                task_id, DeleteScope.TASK_WITH_SUBTASKS
            )
        ...
        mock_repositories[
            "subtask_repository"
        ].count_by_parent_task_id.assert_called_once()
        mock_repositories[
            "subtask_repository"
        ].delete_by_parent_task_id.assert_called_once()
    ...
    def test_delete_task_full_cascade(self, service, mock_repositories, mock_task):
        ...
        mock_repositories["context_repository"].delete.assert_called_once_with(
            mock_task.context_id
        )
    ...
    def test_delete_task_context_failure(self, service, mock_repositories, mock_task):
        ...
        mock_repositories["task_repository"].find_by_id.return_value = mock_task
        mock_repositories["task_repository"].delete.return_value = True
        mock_repositories["context_repository"].delete.side_effect = Exception(
...
class TestBranchCascadeDeletion(TestCascadeDeletionService):
    ...
    def test_delete_branch_cascade_success(
        self, service, mock_repositories, mock_branch
    ):
        ...
        mock_repositories[
            "task_repository"
        ].find_by_git_branch_id.return_value = mock_tasks
    ...
    def test_delete_branch_with_deleted_tasks(self, service, mock_repositories):
        ...
        mock_repositories[
            "task_repository"
        ].delete.return_value = True  # Task deletion succeeds
...
class TestProjectCascadeDeletion(TestCascadeDeletionService):
    ...
    def test_delete_project_cascade_success(
        self, service, mock_repositories, mock_project
    ):
        ...
        mock_repositories[
            "branch_repository"
        ].find_by_project_id.return_value = mock_branches
        ...
        mock_repositories[
            "branch_repository"
        ].find_by_id.side_effect = mock_find_branch_by_id
        mock_repositories["branch_repository"].delete.return_value = True
        mock_repositories["task_repository"].find_by_git_branch_id.return_value = []
        mock_repositories["context_repository"].delete.return_value = True
    ...
    def test_delete_project_with_deleted_branches(self, service, mock_repositories):
        ...
        mock_repositories[
            "branch_repository"
        ].delete.return_value = True  # Branch deletion succeeds
        mock_repositories["project_repository"].delete.return_value = True
    ...
    def test_delete_project_with_full_hierarchy(
        self, service, mock_repositories, mock_project
    ):
...
class TestEventDispatching(TestCascadeDeletionService):
    ...
    @patch(
        "fastmcp.task_management.domain.events.task_lifecycle_events.TaskDeletedEvent"
    )
    def test_task_deleted_event_dispatched(
        self, mock_event_class, mock_dispatch, service, mock_repositories, mock_task
    ):
    ...
    def test_event_dispatch_failure_handled(
        self, mock_dispatch, service, mock_repositories, mock_task
    ):
...
class TestSubtaskDeletion(TestCascadeDeletionService):
    ...
    def test_delete_subtasks_success(self, service, mock_repositories):
        ...
        mock_repositories[
            "subtask_repository"
        ].count_by_parent_task_id.return_value = 10
        mock_repositories[
            "subtask_repository"
        ].delete_by_parent_task_id.return_value = True
        ...
        mock_repositories[
            "subtask_repository"
        ].count_by_parent_task_id.assert_called_once_with(task_id)
        mock_repositories[
            "subtask_repository"
        ].delete_by_parent_task_id.assert_called_once_with(task_id)
    ...
    def test_delete_subtasks_failure(self, service, mock_repositories):
        ...
        mock_repositories[
            "subtask_repository"
        ].delete_by_parent_task_id.return_value = False
    ...
    def test_delete_subtasks_exception(self, service, mock_repositories):
        ...
        mock_repositories[
            "subtask_repository"
        ].count_by_parent_task_id.side_effect = Exception("DB error")
...
class TestEdgeCases(TestCascadeDeletionService):
    ...
    def test_string_task_id_conversion(self, service, mock_repositories, mock_task):
        ...
        mock_repositories[
            "task_repository"
        ].find_by_id.side_effect = verify_task_id_type
        mock_repositories["task_repository"].delete.return_value = True
