...
class TestTemplateEntity:
    ...
    def test_create_template_with_whitespace_name_raises_error(
    ...
    def test_create_template_with_empty_description_raises_error(
        self, valid_template_data
    ):
    ...
    def test_remove_compatible_agent_existing_agent_success(
        self, mock_datetime, template
    ):
    ...
    def test_remove_file_pattern_existing_pattern_success(
        self, mock_datetime, template
    ):
...
class TestTemplateRenderRequestEntity:
    ...
    def test_template_render_request_creation_success(self, render_request):
        ...
        assert render_request.task_context == {
            "task_id": "123",
