...
class TestTaskStatus:
    ...
    def test_can_transition_to_from_todo(self):
        ...
        assert (
            todo.can_transition_to("done") is True
        )  # Direct completion allowed per business rules
    ...
    def test_can_transition_to_from_blocked(self):
        ...
        assert (
            blocked.can_transition_to("done") is False
        )  # Cannot skip directly from blocked to done
