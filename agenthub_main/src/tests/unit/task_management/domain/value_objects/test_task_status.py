...
class TestTaskStatusIntegration:
    ...
    def test_typical_task_lifecycle(self):
        ...
        assert task_status.can_transition_to(
            "in_progress"
        )  # Can transition back to in_progress for rework
