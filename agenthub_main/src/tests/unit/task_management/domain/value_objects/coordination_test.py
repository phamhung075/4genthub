...
class TestWorkAssignment:
    ...
    def test_to_task_context(self):
        ...
        assert context["assignment"]["responsibilities"] == [
            "Implement API",
            "Write tests",
        ]
...
class TestConflictResolution:
    ...
    def test_resolve_conflict(self):
        ...
        assert (
            resolution.resolution_details == "Combined best aspects of both approaches"
        )
...
class TestAgentCommunication:
    ...
    def test_needs_urgent_response_approaching_deadline(self):
        ...
        communication = AgentCommunication(
            ...
            priority="normal",
            requires_response=True,
            response_deadline=datetime.now(UTC)
            + timedelta(hours=1.5),  # Less than 2 hours
        )
    ...
    def test_needs_urgent_response_distant_deadline(self):
        ...
        communication = AgentCommunication(
            ...
            requires_response=True,
            response_deadline=datetime.now(UTC)
            + timedelta(days=1),  # More than 2 hours
        )
