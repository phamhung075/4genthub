...
class TestHintMetadata:
    ...
    def test_effectiveness_score_validation(self):
        ...
        HintMetadata(source="test", confidence=0.5, reasoning="test", effectiveness_score=0.0)
        HintMetadata(source="test", confidence=0.5, reasoning="test", effectiveness_score=1.0)
        HintMetadata(source="test", confidence=0.5, reasoning="test", effectiveness_score=0.7)
        
        # Invalid effectiveness scores
        with pytest.raises(ValueError, match="Effectiveness score must be between 0.0 and 1.0"):
            HintMetadata(source="test", confidence=0.5, reasoning="test", effectiveness_score=-0.1)
        
        with pytest.raises(ValueError, match="Effectiveness score must be between 0.0 and 1.0"):
            HintMetadata(source="test", confidence=0.5, reasoning="test", effectiveness_score=1.5)
