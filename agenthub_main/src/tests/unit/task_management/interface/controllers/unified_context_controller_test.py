...
class TestUnifiedContextMCPController:
    ...
    @patch(
        "fastmcp.task_management.interface.mcp_controllers.unified_context_controller.unified_context_controller.get_authenticated_user_id"
    )
    @patch(
        "fastmcp.auth.middleware.request_context_middleware.get_current_request_context"
    )
    def test_manage_context_create_action(
        self,
        mock_get_request_context,
        mock_get_user_id,
        controller,
        mock_mcp_server,
        mock_facade_service,
        ...
        mock_facade_service.get_context_facade.assert_called_once_with(
            user_id="authenticated-user", project_id=None, git_branch_id=None
        )
    ...
    def test_manage_context_get_action(
        self,
        mock_get_request_context,
        mock_get_user_id,
        controller,
    ...
    def test_manage_context_update_action(
        self,
        mock_get_request_context,
        mock_get_user_id,
        controller,
    ...
    def test_manage_context_delete_action(
        self,
        mock_get_request_context,
        mock_get_user_id,
        controller,
        ...
        result = manage_context(action="delete", level="task", context_id="task-999")

        mock_facade.delete_context.assert_called_once_with(
            level="task", context_id="task-999"
        )
    ...
    def test_manage_context_resolve_action(
        self,
        mock_get_request_context,
        mock_get_user_id,
        controller,
        ...
        result = manage_context(
            action="resolve", level="task", context_id="task-111", force_refresh=True
        )

        mock_facade.resolve_context.assert_called_once_with(
            level="task", context_id="task-111", force_refresh=True
        )
    ...
    def test_manage_context_delegate_action(
        self,
        mock_get_request_context,
        mock_get_user_id,
        controller,
    ...
    def test_manage_context_add_insight_action(
        self,
        mock_get_request_context,
        mock_get_user_id,
        controller,
    ...
    def test_manage_context_add_progress_action(
        self,
        mock_get_request_context,
        mock_get_user_id,
        controller,
    ...
    def test_manage_context_list_action(
        self,
        mock_get_request_context,
        mock_get_user_id,
        controller,
        ...
        result = manage_context(
            action="list", level="project", filters={"status": "active"}
        )

        mock_facade.list_contexts.assert_called_once_with(
            level="project", filters={"status": "active"}
        )
    ...
    def test_manage_context_invalid_action(
        self, mock_get_user_id, controller, mock_mcp_server
    ):
        ...
        result = manage_context(
            action="invalid_action", level="task", context_id="task-555"
        )
    ...
    def test_manage_context_json_string_data(
        self,
        mock_get_request_context,
        mock_get_user_id,
        controller,
        ...
        result = manage_context(
            action="create", level="task", context_id="task-666", data=json_data
        )
    ...
    def test_manage_context_invalid_json_data(
        self, mock_get_user_id, controller, mock_mcp_server
    ):
        ...
        result = manage_context(
            action="create", level="task", context_id="task-777", data='{"invalid json}'
        )
    ...
    def test_manage_context_boolean_parameter_coercion(
        self,
        mock_get_request_context,
        mock_get_user_id,
        controller,
    ...
    def test_manage_context_authentication_error(
        self, mock_get_user_id, controller, mock_mcp_server
    ):
        ...
        result = manage_context(action="create", level="task", context_id="task-999")
        ...
        assert (
            "could not be completed" in error_content
            or "Authentication required" in error_content
            or "USER_AUTHENTICATION_REQUIRED" in str(result.get("error_code", ""))
        )
    ...
    def test_manage_context_facade_error(
        self,
        mock_get_request_context,
        mock_get_user_id,
        controller,
