...
class TestGitBranchUserIdParameter:
    ...
    def setup_method(self):
        ...
        with patch(
            "fastmcp.task_management.interface.mcp_controllers.git_branch_mcp_controller.git_branch_mcp_controller.GitBranchWorkflowFactory"
        ):
    ...
    def test_user_id_passed_to_facade_creation(self):
        ...
        with patch(
            "fastmcp.task_management.interface.mcp_controllers.git_branch_mcp_controller.git_branch_mcp_controller.get_authenticated_user_id"
        ) as mock_auth:
            with patch.object(
    ...
    def test_all_actions_accept_user_id(self):
        ...
        test_cases = [
            ...
            (
                "unassign_agent",
                {"git_branch_id": "branch-123", "agent_id": "agent-456"},
            ),
    ...
    def test_mcp_tool_registration_includes_user_id(self):
        ...
        )  # Mock decorator that returns the function
