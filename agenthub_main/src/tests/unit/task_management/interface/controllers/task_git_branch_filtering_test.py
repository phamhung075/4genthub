...
class TestTaskGitBranchFiltering:
    ...
    def test_list_tasks_filters_by_branch_id(self, mock_get_auth_user_id):
        ...
        call_args = self.mock_facade.list_tasks.call_args[0][
            0
    ...
    def test_list_tasks_different_branches_return_different_results(
        self, mock_get_auth_user_id
    ):
    ...
    def test_list_tasks_empty_branch_returns_no_tasks(self, mock_get_auth_user_id):
        ...
        self.mock_facade.list_tasks.return_value = {"success": True, "tasks": []}
    ...
    def test_list_tasks_without_branch_filter_may_return_all_tasks(
        self, mock_get_auth_user_id
    ):
    ...
    def test_list_tasks_invalid_branch_id_returns_empty_or_error(
        self, mock_get_auth_user_id
    ):
...
class TestTaskGitBranchFilteringIntegration:
    ...
    @pytest.mark.asyncio
    async def test_full_mcp_controller_list_action_filters_by_branch(
        self, mock_get_auth_user_id
    ):
...
if __name__ == "__main__":
    ...
    pytest.main(
        [
            __file__
            + "::TestTaskGitBranchFiltering::test_list_tasks_filters_by_branch_id",
            "-v",
            "--tb=short",
        ]
    )
