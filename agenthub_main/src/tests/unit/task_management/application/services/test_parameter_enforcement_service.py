...
class TestParameterEnforcementService:
    ...
    def test_complete_action_requires_completion_summary(self):
        ...
        result = service.enforce(
            action="complete", provided_params={}, agent_id="test_agent"
        )
    ...
    def test_agent_compliance_tracking(self):
        ...
        service.enforce(action="update", provided_params={}, agent_id="test_agent")
    ...
    def test_subtask_operations(self):
        ...
        # Subtask update
        result = service.enforce(
            action="subtask_update", provided_params={}, agent_id="test_agent"
        )
        ...
        result = service.enforce(
            ...
            provided_params={"completion_summary": "Subtask completed"},
            agent_id="test_agent",
        )
    ...
    def test_unknown_action_has_no_requirements(self):
        ...
        result = service.enforce(
            action="unknown_action", provided_params={}, agent_id="test_agent"
        )
