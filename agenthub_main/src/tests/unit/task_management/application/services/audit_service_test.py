...
class TestAuditServiceLogging:
    ...
    def test_log_operation_with_string_compliance_level(self):
        ...
        with patch(
            "fastmcp.task_management.application.services.audit_service.logger"
        ) as mock_logger:
    ...
    def test_get_audit_log(self):
        ...
        for i in range(5):
            service.log_operation(
                f"operation_{i}", {"success": True}, ComplianceLevel.MEDIUM
            )
...
class TestAuditServiceReporting:
    ...
    def test_generate_compliance_report_with_data(self):
        ...
        for i in range(8):
            service.log_operation(
                f"good_op_{i}",
                {"success": True, "compliance_score": 90},
        ...
        for i in range(2):
            service.log_operation(
                f"bad_op_{i}",
                {"success": False, "compliance_score": 50},
                ComplianceLevel.HIGH,
            )
    ...
    def test_generate_compliance_report_error_handling(self):
        ...
        with patch.object(
            service, "_compliance_metrics", side_effect=Exception("Test error")
        ):
            report = service.generate_compliance_report()
    ...
    def test_calculate_compliance_trend_improving(self):
        ...
        for i in range(10):
            service.log_operation(
                f"bad_op_{i}", {"success": False}, ComplianceLevel.HIGH
            )

        # Add 10 successful operations
        for i in range(10):
            service.log_operation(
                f"good_op_{i}", {"success": True}, ComplianceLevel.HIGH
            )
    ...
    def test_generate_recommendations_good_compliance(self):
        ...
        for i in range(10):
            service.log_operation(
                f"op_{i}",
                {"success": True, "compliance_score": 95},
                ComplianceLevel.HIGH,
            )
    ...
    def test_generate_recommendations_poor_compliance(self):
        ...
        assert any(
            "High number of violations detected" in rec for rec in recommendations
        )
...
class TestAuditServiceManagement:
    ...
    def test_get_compliance_metrics(self):
        ...
        # Add some operations
        service.log_operation(
            "op1", {"success": True, "compliance_score": 90}, ComplianceLevel.HIGH
        )
        service.log_operation(
            "op2", {"success": False, "compliance_score": 40}, ComplianceLevel.HIGH
        )
