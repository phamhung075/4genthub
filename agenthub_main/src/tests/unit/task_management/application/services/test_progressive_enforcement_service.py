...
class TestProgressiveEnforcementService:
    ...
    def test_new_agent_starts_with_default_level(self):
        ...
        self.service.enforce_with_progression(
            action="update", provided_params={}, agent_id="new_agent"
        )
    ...
    def test_learning_phase_more_lenient(self):
        ...
        result = self.service.enforce_with_progression(
            action="update", provided_params={}, agent_id="test_agent"
        )
    ...
    def test_compliance_rate_tracking(self):
        ...
        for i in range(10):
            ...
            result = self.service.enforce_with_progression(
                action="update", provided_params=params, agent_id=agent_id
            )
        ...
        result = self.service.enforce_with_progression(
            action="update", provided_params={}, agent_id=agent_id
        )
    ...
    def test_hints_include_learning_phase_info(self):
        ...
        assert any(
            "Learning phase" in hint and "9 operations remaining" in hint
    ...
    def test_should_escalate_from_compliance_rate(self):
        ...
        for i in range(10):
            params = (
                {"work_notes": "Work", "progress_made": "Progress"}
                if i % 2 == 0
                else {}
            )
            self.service.enforce_with_progression(
    ...
    def test_should_escalate_from_warnings_at_warning_level(self):
        ...
        assert (
            profile.warnings_received >= 10
            or profile.enforcement_level == EnforcementLevel.STRICT
        )
    ...
    def test_should_deescalate_high_compliance_branch(self):
        ...
        compliance_rate = sum(profile.compliance_history[-20:]) / len(
            profile.compliance_history[-20:]
        )
    ...
    def test_enforcement_stats_no_compliance_history(self):
        ...
        fresh_service = ProgressiveEnforcementService(
            default_level=EnforcementLevel.WARNING
        )
