...
class TestGitBranchFacadeFactory:
    ...
    def test_create_git_branch_facade_new(self, factory):
        ...
        with patch('fastmcp.task_management.application.services.repository_provider_service.RepositoryProviderService') as mock_repo_provider_class:
            ...
            mock_git_branch_repo.with_user = MagicMock(return_value=mock_git_branch_repo)
