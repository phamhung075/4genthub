...
class TestGitBranchFacadeFactory:
    ...
    def reset_singleton(self):
        ...
        GitBranchFacadeFactory._instance = None
        GitBranchFacadeFactory._initialized = False
        yield
        # Clean up after test
        GitBranchFacadeFactory._instance = None
        GitBranchFacadeFactory._initialized = False
    ...
    def test_init(self, mock_git_branch_repository_factory):
        ...
        assert (
            factory._git_branch_repository_factory == mock_git_branch_repository_factory
        )
    ...
    def test_create_git_branch_facade_new(self, factory):
        ...
        with patch(
            "fastmcp.task_management.application.services.repository_provider_service.RepositoryProviderService"
        ) as mock_repo_provider_class:
            mock_repo_provider = MagicMock()
            mock_repo_provider_class.get_instance.return_value = mock_repo_provider

            mock_project_repo = MagicMock()
            mock_git_branch_repo = MagicMock()
            # Mock the with_user method to return the same repo (for chaining)
            mock_project_repo.with_user = MagicMock(return_value=mock_project_repo)
            mock_git_branch_repo.with_user = MagicMock(
                return_value=mock_git_branch_repo
            )
            mock_repo_provider.get_project_repository.return_value = mock_project_repo
            mock_repo_provider.get_git_branch_repository.return_value = (
                mock_git_branch_repo
            )

            with patch(
                "fastmcp.task_management.application.services.git_branch_service.GitBranchService"
                ...
                # Verify with_user was called on repositories
                mock_project_repo.with_user.assert_called_once_with("test-user")
                mock_git_branch_repo.with_user.assert_called_once_with("test-user")

                # Verify service was created with repositories and user_id
    ...
    def test_create_git_branch_facade_different_users(self, factory):
        ...
        with patch(
            ...
            with patch(
                ...
                facade1 = factory.create_git_branch_facade(
                    project_id="test-project", user_id="user1"
                )

                # Create facade for user2
                facade2 = factory.create_git_branch_facade(
                    project_id="test-project", user_id="user2"
                )
    ...
    def test_create_git_branch_facade_no_user(self, factory):
        ...
        with patch(
            ...
            with patch(
                ...
                facade = factory.create_git_branch_facade(project_id="test-project")
    ...
    def test_create_git_branch_facade_default_project(self, factory):
        ...
        with patch(
            ...
            with patch(
                ...
                # Should use None project_id (default is None not "default_project")
                cache_key = "None:no_user"
                assert factory._facades_cache[cache_key] == facade
    ...
    def test_get_cached_facade_exists(self, factory):
        ...
        with patch(
            ...
            with patch(
                ...
                # Create a facade
                created_facade = factory.create_git_branch_facade(
        ...
        with patch(
            ...
            with patch(
                ...
                facade_user1 = factory.create_git_branch_facade(
                    project_id="shared-project", user_id="user1"
                )
                facade_user2 = factory.create_git_branch_facade(
                    project_id="shared-project", user_id="user2"
                )
    ...
    def test_logging_messages(self, factory, caplog):
        ...
        caplog.set_level(
            logging.DEBUG,
            logger="fastmcp.task_management.application.factories.git_branch_facade_factory",
        )
        ...
        with patch(
            ...
            with patch(
                ...
                factory.create_git_branch_facade(project_id="log-test", user_id="user1")
                assert (
                    "Returning cached git branch facade for log-test:user1"
                    in caplog.text
                )
