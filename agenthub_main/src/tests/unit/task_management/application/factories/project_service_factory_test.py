...
class TestProjectServiceFactory:
    ...
    def factory(self, mock_path_resolver, mock_project_repository):
        ...
        return ProjectServiceFactory(
            path_resolver=mock_path_resolver, project_repository=mock_project_repository
        )
    ...
    def factory_no_repo(self, mock_path_resolver):
        ...
        return ProjectServiceFactory(
            path_resolver=mock_path_resolver, project_repository=None
        )

    def test_factory_initialization(
        self, factory, mock_path_resolver, mock_project_repository
    ):
    ...
    def test_create_project_service_with_repository(
        self, factory, mock_project_repository
    ):
    ...
    @patch(
        "fastmcp.task_management.infrastructure.factories.project_service_factory.get_default_repository"
    )
    def test_create_project_service_without_repository(
        self, mock_get_default_repo, factory_no_repo
    ):
    ...
    def test_create_project_application_service_with_repository(
        self, factory, mock_project_repository
    ):
    ...
    @patch(
        "fastmcp.task_management.infrastructure.factories.project_service_factory.ProjectRepositoryFactory"
    )
    def test_create_project_application_service_without_repository(
        self, mock_repo_factory, factory_no_repo
    ):
    ...
    @patch(
        "fastmcp.task_management.infrastructure.factories.project_service_factory.get_sqlite_repository"
    )
    def test_create_sqlite_service(self, mock_get_sqlite_repo, factory):
        ...
        service = factory.create_sqlite_service(
            user_id="user-123", db_path="/test/db.sqlite"
        )

        assert isinstance(service, ProjectApplicationService)
        mock_get_sqlite_repo.assert_called_once_with(
            user_id="user-123", db_path="/test/db.sqlite"
        )
    ...
    @patch(
        "fastmcp.task_management.infrastructure.factories.project_service_factory.RepositoryConfig"
    )
    ...
    def test_get_default_repository_without_repo(
        self, mock_get_default, factory_no_repo
    ):
    ...
    def test_get_repository_for_user_without_repo(
        self, mock_repo_factory, factory_no_repo
    ):
...
class TestProjectServiceFactoryConvenienceFunctions:
    ...
    @patch(
        "fastmcp.task_management.infrastructure.factories.project_service_factory.PathResolver"
    )
    ...
    def test_create_project_service_factory_with_dependencies(self):
        ...
        factory = create_project_service_factory(
            path_resolver=mock_path_resolver, project_repository=mock_repo
        )
    ...
    @patch(
        "fastmcp.task_management.infrastructure.factories.project_service_factory.create_project_service_factory"
    )
    ...
    def test_create_project_service_for_user(self, mock_create_factory):
        ...
        assert service == mock_service
        mock_create_factory.assert_called_once()
        mock_factory.create_project_application_service.assert_called_once_with(
            user_id="user-123"
        )
...
class TestProjectServiceFactoryIntegration:
    ...
    def test_repository_selection_priority(
        self, mock_repo_factory, mock_get_default, mock_path_resolver
    ):
        ...
        factory = ProjectServiceFactory(
            path_resolver=mock_path_resolver, project_repository=mock_injected_repo
        )
...
class TestProjectServiceFactoryErrorHandling:
    ...
    def test_factory_with_none_path_resolver(self):
        ...
        factory = ProjectServiceFactory(path_resolver=None, project_repository=None)
    ...
    def test_create_service_from_environment_error_handling(
        self, mock_repo_config, mock_path_resolver
    ):
