...
class TestProjectFacadeFactory:
    ...
    def setup_method(self):
        ...
        self.mock_repository_provider.get_project_repository.return_value = (
    ...
    @patch(
        "fastmcp.task_management.application.factories.project_facade_factory.RepositoryProviderService"
    )
    def test_get_instance(self, mock_repo_provider_service):
        ...
        mock_repo_provider_service.get_instance.return_value = (
            self.mock_repository_provider
        )
    ...
    def test_create_project_facade_success(self):
        ...
        self.mock_repository_provider.get_project_repository.assert_called_once_with(
            user_id
        )
    ...
    def test_create_project_facade_with_repository_error(self):
        ...
        self.mock_repository_provider.get_project_repository.side_effect = Exception(
            "Repository error"
        )
    ...
    @patch(
        "fastmcp.task_management.application.factories.project_facade_factory.logger"
    )
