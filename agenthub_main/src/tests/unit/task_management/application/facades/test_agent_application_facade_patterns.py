    ...
    def test_register_agent_pattern(self):
        ...
        def register_agent(project_id, agent_id, name, call_agent=None):
            try:
                ...
                return {"success": False, "action": "register", "error": str(e)}

        # Act
        result = register_agent(
            "project-1", "agent-1", "Test Agent", "call_agent_config"
        )
    ...
    def test_assign_agent_pattern(self):
        ...
        def assign_agent(project_id, agent_id, git_branch_id):
            try:
                ...
                return {"success": False, "action": "assign", "error": str(e)}
        ...
        def list_agents(project_id):
            try:
                ...
                if response.success:
                    ...
                    return {"success": False, "action": "list", "error": response.error}
            except Exception as e:
    ...
    def test_rebalance_agents_pattern(self):
        ...
        def rebalance_agents(project_id):
            try:
                ...
                return {"success": False, "action": "rebalance", "error": str(e)}
    ...
    def test_get_agent_with_details_pattern(self):
        ...
        def get_agent(project_id, agent_id):
            try:
                ...
                if response.success:
                    return {"success": True, "action": "get", "agent": response.agent}
                else:
                    return {"success": False, "action": "get", "error": response.error}
            except Exception as e:
