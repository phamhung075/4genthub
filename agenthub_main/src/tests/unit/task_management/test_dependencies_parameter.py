...
def create_mock_facade():
    ...
    mock_facade.create_task = MagicMock(
        return_value={
            "success": True,
            "task": {
                "id": "test-task-123",
    ...
    with patch(
        ...
        try:
            ...
            if result.get("success"):
                ...
                print(
                    f"   ❌ Single string format failed: {result.get('error', result)}"
                )
        except Exception as e:
        ...
        try:
            ...
            if result.get("success"):
                ...
                print(
                    f"   ❌ Comma-separated format failed: {result.get('error', result)}"
                )
        except Exception as e:
        ...
        try:
            ...
            if result.get("success"):
                ...
                print(
                    f"   ❌ Comma-separated with spaces format failed: {result.get('error', result)}"
                )
        except Exception as e:
