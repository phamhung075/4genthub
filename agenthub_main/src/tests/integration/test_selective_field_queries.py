...
class TestSelectiveFieldQueries(unittest.TestCase):
    ...
    def test_get_task_fields(self):
        ...
        self.assertTrue(
            len(result["fields"])
            > len(self.field_selector.TASK_FIELD_SETS[FieldSet.MINIMAL])
        )
    ...
    def test_get_context_fields(self):
        ...
        # Test minimal field set
        result = self.field_selector.get_context_fields(
            context_id, level, FieldSet.MINIMAL
        )
    ...
    def test_field_dependencies_expansion(self):
        ...
        expanded_fields = self.field_selector._expand_field_dependencies(
            original_fields
        )
    ...
    def test_metrics_tracking(self):
        ...
        self.assertGreater(
            updated_metrics["queries_optimized"], initial_metrics["queries_optimized"]
        )
    ...
    def test_estimate_savings(self):
        ...
        project_savings = self.field_selector.estimate_savings(
            "project", FieldSet.MINIMAL
        )
