...
class TestPlannedTask:
    ...
    def test_planned_task_with_full_details(self):
        ...
        assignment = AgentAssignment(
            primary_agent="backend-agent", supporting_agents=["api-specialist-agent"]
        )
        ...
        task = PlannedTask(
            ...
            code_references={"auth/jwt.js": ["45-89", "120-150"]},
            priority="high",
    ...
    def test_to_mcp_task_request(self):
        ...
        assignment = AgentAssignment(
            primary_agent="coding-agent", supporting_agents=["review-agent"]
        )
