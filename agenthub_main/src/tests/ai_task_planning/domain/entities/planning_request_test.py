...
class TestRequirementItem:
    ...
    def test_create_requirement_item(self):
        ...
        req = RequirementItem(
            id="req_1", description="Implement user authentication", priority="high"
        )
...
class TestPlanningRequest:
    ...
    def test_add_requirement(self):
        ...
        request = PlanningRequest(
            id="plan_123", title="Auth System", description="Build authentication"
        )
        ...
        req2 = request.add_requirement(
            description="Create logout endpoint", priority="medium"
        )
    ...
    def test_estimate_overall_complexity_empty(self):
        ...
        request = PlanningRequest(
            id="plan_123", title="Empty Plan", description="Plan with no requirements"
        )
    ...
    def test_estimate_overall_complexity_with_estimates(self):
        ...
        request = PlanningRequest(
            id="plan_123", title="Complex System", description="Multi-agent system"
        )
    ...
    def test_from_dict_deserialization(self):
        ...
        data = {
            ...
            "code_references": {"module.py": ["100-200", "250-300"]},
