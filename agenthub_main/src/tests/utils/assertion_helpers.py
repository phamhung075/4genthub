...
def assert_task_structure(
    task_data: dict[str, Any], required_fields: list[str | None] = None
) -> None:
    """
    ...
    default_required = ["id", "title", "status", "priority", "created_at", "updated_at"]
...
def assert_context_inheritance(
    context_data: dict[str, Any], expected_inheritance_chain: list[str]
) -> None:
    """
...
def assert_mcp_tool_response(
    response: dict[str, Any], expected_success: bool = True
) -> None:
    """
...
def assert_database_foreign_key_constraint(
    test_data: dict[str, Any], foreign_key_field: str, referenced_table: str
) -> None:
    """
...
def assert_test_isolation(test_id: str, file_paths: list[str]) -> None:
    ...
    for file_path in file_paths:
        ...
        is_test_file = (
            test_id in file_path
            or "test" in file_path.lower()
            or file_path.endswith(".test.json")
