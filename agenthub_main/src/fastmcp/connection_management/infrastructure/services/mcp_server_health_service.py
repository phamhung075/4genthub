...
class MCPServerHealthService(ServerHealthService):
    ...
    def get_environment_info(self) -> dict[str, Any]:
        ...
        return {
            ...
            "database_configured": bool(
                os.environ.get("SUPABASE_URL") or os.environ.get("DATABASE_URL")
            ),
            ...
            "services_configured": {
                ...
                "authentication": os.environ.get("AUTH_ENABLED", "true").lower()
                == "true",
    ...
    def validate_server_configuration(self) -> dict[str, Any]:
        ...
        try:
            ...
            return {
                "active_connections": connection_stats.get("connections", {}).get(
                    "active_connections", 0
                ),
                "server_restart_count": connection_stats.get("server_info", {}).get(
                    "restart_count", 0
                ),
                "uptime_seconds": connection_stats.get("server_info", {}).get(
                    "uptime_seconds", 0
                ),
