...
class ConnectionMCPController:
    ...
    def register_tools(self, mcp: FastMCP):
        ...
        def manage_connection(
            ...
            return self.health_check(include_details=include_details, user_id=user_id)

    def health_check(
        self, include_details: bool = True, user_id: str | None = None
    ) -> dict[str, Any]:
        """
        ...
        """
        try:
            response = self._connection_facade.check_server_health(
                include_details, user_id
            )
        ...
        if response.success:
            ...
            if hasattr(response, "task_management") and response.task_management:
                sanitized_response["task_management"] = {
                    "enabled": response.task_management.get(
