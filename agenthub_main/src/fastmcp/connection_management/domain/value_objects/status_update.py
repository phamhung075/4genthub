...
class StatusUpdate:
    ...
    def __post_init__(self):
        ...
        if self.event_type not in valid_event_types:
            raise ValueError(
                f"Invalid event type: {self.event_type}. Must be one of {valid_event_types}"
            )
    ...
    @classmethod
    def create_server_health_update(
        cls, session_id: str, health_status: str, details: dict[str, Any]
    ) -> "StatusUpdate":
        ...
        return cls(
            ...
            data={"health_status": health_status, **details},
        )

    @classmethod
    def create_connection_update(
        cls, session_id: str, connection_id: str, event: str
    ) -> "StatusUpdate":
    ...
    @classmethod
    def create_client_registration_update(
        cls, session_id: str, registered: bool
    ) -> "StatusUpdate":
