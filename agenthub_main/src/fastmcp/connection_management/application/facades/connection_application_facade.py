...
class ConnectionApplicationFacade:
    ...
    def __init__(
        ...
        self._check_health_use_case = CheckServerHealthUseCase(
            server_repository, health_service
        )
        self._get_capabilities_use_case = GetServerCapabilitiesUseCase(
            server_repository, health_service
        )
        self._check_connection_health_use_case = CheckConnectionHealthUseCase(
            connection_repository, diagnostics_service
        )
        ...
        self._register_updates_use_case = RegisterStatusUpdatesUseCase(
    ...
    def check_server_health(
        self, include_details: bool = True, user_id: str = None
    ) -> HealthCheckResponse:
    ...
    def check_connection_health(
        ...
        try:
            request = ConnectionHealthRequest(
                connection_id=connection_id, include_details=include_details
            )
    ...
    def register_for_status_updates(
        self, session_id: str, client_info: dict[str, Any] = None, user_id: str = None
    ) -> RegisterUpdatesResponse:
