...
class JWTService:
    ...
    def __init__(self, secret_key: str, issuer: str = "agenthub"):
        """
    ...
    def create_refresh_token(
        self, user_id: str, token_family: str | None = None, token_version: int = 0
    ) -> tuple[str, str]:
        """
        ...
        try:
            ...
            if token_type != expected_type:
                ...
                if expected_type == "access" and token_type == "api_token":
                    logger.debug(
                        "Accepting api_token type for access token compatibility"
                    )
                    ...
                    logger.debug(
                        "Accepting token without 'type' field (likely Supabase token)"
                    )
                else:
                    logger.warning(
    ...
    def generate_token(
        ...
        """
        Generate an API token with specified scopes and expiration.
        ...
        Args:
            ...
            audience: Token audience (defaults to "mcp-server")
