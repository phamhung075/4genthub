...
class PlanningRequest:
    ...
    code_references: dict[str, list[str]] = field(
            ...
            "requirements": [
                {
                    ...
                    "estimated_complexity": req.estimated_complexity.value
                    if req.estimated_complexity
                    else None,
                }
                for req in self.requirements
    ...
    def from_dict(cls, data: dict[str, Any]) -> PlanningRequest:
        ...
        requirements = [
            RequirementItem(
                ...
                estimated_complexity=ComplexityLevel(req["estimated_complexity"])
                if req.get("estimated_complexity")
                else None,
            )
