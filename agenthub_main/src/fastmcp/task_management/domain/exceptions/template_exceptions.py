...
class TemplateValidationError(TemplateError):
    ...
    def __init__(self, message: str, template_id: str | None = None, validation_errors: list[str] | None = None):
...
class TemplateRenderError(TemplateError):
    ...
    def __init__(self, message: str, template_id: str | None = None, render_context: dict[str, Any] | None = None):
        super().__init__(message, template_id)
...
class TemplateCompilationError(TemplateError):
    ...
    def __init__(self, message: str, template_id: str | None = None, compilation_errors: list[str] | None = None):
        super().__init__(message, template_id)
...
class TemplateVariableError(TemplateError):
    ...
    def __init__(self, message: str, template_id: str | None = None, variable_name: str | None = None):
        super().__init__(message, template_id)
...
class TemplatePermissionError(TemplateError):
    ...
    def __init__(self, message: str, template_id: str | None = None, required_permission: str | None = None):
        super().__init__(message, template_id)
...
class TemplateVersionError(TemplateError):
    ...
    def __init__(self, message: str, template_id: str | None = None, version: int | None = None):
        super().__init__(message, template_id)
...
class TemplateCacheError(TemplateError):
    ...
    def __init__(self, message: str, template_id: str | None = None, cache_key: str | None = None):
        super().__init__(message, template_id)
...
class TemplateCompatibilityError(TemplateError):
    ...
    def __init__(self, message: str, template_id: str | None = None, agent_name: str | None = None):
        super().__init__(message, template_id)
...
class TemplateRegistrationError(TemplateError):
    ...
    def __init__(self, message: str, template_id: str | None = None, registration_errors: list[str] | None = None):
        super().__init__(message, template_id)
...
class TemplateUsageError(TemplateError):
    ...
    def __init__(self, message: str, template_id: str | None = None, usage_data: dict[str, Any] | None = None):
        super().__init__(message, template_id)
