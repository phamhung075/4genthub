...
class AgentSession(BaseTimestampEntity):
    ...
    def allocate_resource(
        self, resource_type: ResourceType, amount: float, resource_id: str | None = None
    ) -> ResourceUsage:
    ...
    def open_channel(
        self, channel_id: str, channel_type: str, participants: list[str]
    ) -> CommunicationChannel:
        """Open a communication channel"""
        channel = CommunicationChannel(
            channel_id=channel_id, channel_type=channel_type, participants=participants
        )
    ...
    def add_message(
        self, message: CoordinationMessage, is_outgoing: bool = True
    ) -> None:
    ...
    def needs_recovery(self) -> bool:
        ...
        return (
            self.calculate_health_score() < 50
            or self.metrics["error_count"] > 10
