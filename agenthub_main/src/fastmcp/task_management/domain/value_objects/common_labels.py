...
class CommonLabel(Enum):
    ...
    def get_keywords(self) -> list[str]:
        ...
        keyword_map = {
            ...
            self.agenthub: ["task management", "task", "project", "workflow"],
    ...
    def get_type_labels(cls) -> list[str]:
        ...
        return [
            cls.BUG.value,
            cls.FEATURE.value,
            cls.ENHANCEMENT.value,
            cls.REFACTOR.value,
            cls.DOCUMENTATION.value,
            cls.TESTING.value,
            cls.RESEARCH.value,
            cls.SPIKE.value,
        ]
    ...
    def get_ai_labels(cls) -> list[str]:
        ...
        return [
            ...
            cls.MCP.value,
            cls.agenthub.value,
            cls.AUTO_GENERATION.value,
            cls.RULE_GENERATION.value,
        ]
    ...
    def get_testing_labels(cls) -> list[str]:
        ...
        return [
            cls.TESTING.value,
            cls.UNIT_TEST.value,
            cls.INTEGRATION_TEST.value,
            cls.E2E_TEST.value,
            cls.DOMAIN.value,
            cls.ENTITY.value,
            cls.VALUE_OBJECT.value,
            cls.PROJECT.value,
            cls.SUBTASK.value,
        ]
...
class LabelValidator:
    ...
    def validate_labels(labels: list[str]) -> list[str]:
        ...
        for label in labels:
            ...
            if not re.match(r"^[a-zA-Z0-9\-_/]+$", normalized_label):
                raise ValueError(
                    f"Invalid label format: {label} (use alphanumeric, hyphens, underscores only)"
                )
    ...
    def get_label_suggestions(
        existing_labels: list[str], text_content: str = ""
    ) -> list[str]:
