...
class RuleRepository(ABC):
    ...
    @abstractmethod
    async def list_rules(self, filters: dict[str, Any] | None = None) -> list[RuleContent]:
        """List all rules with optional filters"""
        pass
    
    @abstractmethod
    async def list_rule_metadata(self, filters: dict[str, Any] | None = None) -> list[RuleMetadata]:
