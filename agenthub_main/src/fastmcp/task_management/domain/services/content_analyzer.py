...
class ContentAnalyzer:
    ...
    def find_content_matches(
        self, source_features: list[ContentFeature], target_content: str
    ) -> list[EntityMatch]:
        """
        ...
        for pattern, confidence in self.DEPENDENCY_PATTERNS.items():
            ...
            for match in matches:
                ...
                feature = ContentFeature(
                    ...
                    metadata={"pattern": pattern, "full_match": match.group(0)},
                )
        ...
        for entity_type, pattern in self.TECHNICAL_ENTITIES.items():
            ...
            for match in matches:
                ...
                feature = ContentFeature(
                    ...
                    metadata={"entity_type": entity_type, "full_match": match.group(0)},
                )
                features.append(feature)
    ...
    def _calculate_feature_match(
        self, source_feature: ContentFeature, target_feature: ContentFeature
    ) -> EntityMatch | None:
        ...
        if target_feature.feature_type not in compatible_types.get(
        ...
        if (
            source_feature.feature_type == AnalysisType.KEYWORD
            or target_feature.feature_type == AnalysisType.KEYWORD
        ):
    ...
    def analyze_task_relationships(
        self, task_contents: dict[str, str]
    ...
    def get_analysis_summary(self, features: list[ContentFeature]) -> dict[str, Any]:
        ...
        for feature in features:
            ...
            summary["feature_types"][feature_type] = (
                summary["feature_types"].get(feature_type, 0) + 1
            )
