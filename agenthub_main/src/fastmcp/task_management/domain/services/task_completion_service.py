...
class TaskCompletionService:
    ...
    def __init__(
        ...
        task_context_repository: TaskContextRepositoryProtocol | None = None,
    ):
        """
        ...
        try:
            ...
            if subtasks:
                ...
                if incomplete_subtasks:
                    ...
                    blocker_msg = (
                        f"{incomplete_count} of {total_count} subtasks are incomplete"
                    )
    ...
    def _create_incomplete_subtasks_error(
        self, task: Task, incomplete_subtasks: list
    ) -> dict[str, Any]:
        ...
        return {
            ...
            "details": {
                ...
                "incomplete_subtask_titles": [
                    st.title for st in incomplete_subtasks[:3]
                ],
            },
            "recovery_instructions": [
    ...
    def get_subtask_completion_summary(self, task: Task) -> dict:
        ...
        try:
            ...
            logger.error(
                f"Error getting subtask completion summary for task {task.id}: {e}"
            )
            return {
                "total": 0,
                "completed": 0,
