...
class TemplateDomainService:
    ...
    def get_suggestion_reason(
        self, template: Template, task_context: dict[str, Any], score: float
    ) -> str:
    ...
    def validate_render_request(self, request: TemplateRenderRequest) -> list[str]:
        ...
        if request.cache_strategy not in [
            "default",
            "aggressive",
            "minimal",
            "none",
    ...
    def should_cache_result(
        self, template: Template, request: TemplateRenderRequest
    ) -> bool:
        ...
        if request.cache_strategy == "minimal":
            ...
            return template.priority in [
                TemplatePriority.HIGH,
                TemplatePriority.CRITICAL,
            ]
