...
class EventStore:
    ...
    async def append(self, event: Any) -> str:
        ...
        stored_event = StoredEvent(
            ...
            version=1,
            metadata={"source": "event_store", "environment": "production"},
        )
    ...
    async def get_event_count(
        self, aggregate_id: str | None = None, event_type: str | None = None
    ) -> int:
        """
    ...
    async def get_latest_snapshot(self, aggregate_id: str) -> StoredEvent | None:
        """
