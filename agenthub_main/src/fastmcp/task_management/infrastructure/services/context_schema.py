...
class TaskContext:
    ...
    def from_dict(cls, data: dict[str, Any]) -> TaskContext:
        ...
        metadata = ContextMetadata(
            ...
            user_id=metadata_data.get("user_id", ""),  # DDD: No fallback defaults
...
class ContextSchema:
            ...
            "properties": {
                "metadata": {
                    ...
                    "properties": {
                        ...
                        "status": {
                            "type": "string",
                            "enum": [status.value for status in TaskStatusEnum],
                        },
                        "priority": {
                            "type": "string",
                            "enum": [priority.label for priority in PriorityLevel],
                        },
    ...
    def create_empty_context(
        task_id: str, project_id: str, title: str, **kwargs
    ) -> TaskContext:
        ...
        metadata = ContextMetadata(
            ...
            user_id=kwargs.get("user_id", ""),  # DDD: No fallback defaults
