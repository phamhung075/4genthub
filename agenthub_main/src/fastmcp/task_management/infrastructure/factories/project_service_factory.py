...
class ProjectServiceFactory:
    ...
    def create_project_service(
        self, projects_file_path: str | None = None
        ...
        return ProjectManagementService(project_repo=repository)

    def create_project_application_service(
...
def create_project_service_factory(
    ...
    return ProjectServiceFactory(
        path_resolver=path_resolver, project_repository=project_repository
    )
