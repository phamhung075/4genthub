...
def calculate_delay(attempt: int, config: ConnectionRetryConfig) -> float:
    """
...
def with_connection_retry(config: ConnectionRetryConfig | None = None) -> Callable:
    """
    ...
    def receive_checkout(dbapi_conn, connection_record, connection_proxy):
        ...
        if time.time() - connect_time > 1800:  # 30 minutes
            ...
            raise OperationalError(
                "Connection too old, forcing reconnection", None, None
            )
