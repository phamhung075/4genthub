...
class DatabaseSourceManager:
    ...
    def _set_database_path(self) -> None:
        ...
        if self._current_mode == DatabaseMode.TEST:
            ...
            self._database_path = str(project_root / "agenthub_main" / "database" / "data" / "agenthub_test.db")
            ...
            self._database_path = str(project_root / "agenthub_main" / "database" / "data" / "agenthub.db")
    ...
    def _validate_single_source(self) -> None:
        ...
        test_db = project_root / "agenthub_main" / "database" / "data" / "agenthub_test.db"
