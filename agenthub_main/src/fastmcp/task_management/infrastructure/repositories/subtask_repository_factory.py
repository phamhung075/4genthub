...
class SubtaskRepositoryFactory:
    ...
    def __init__(
        ...
        self.base_path = base_path or str(
            self.project_root / ".cursor" / "rules" / "subtasks"
        )
    ...
    def create_sqlite_subtask_repository(
        self,
        project_id: str,
        git_branch_name: str = "main",
    ...
    def create_orm_subtask_repository(
    ...
    def validate_user_project_tree(
        self, project_id: str, git_branch_name: str, user_id: str | None = None
    ) -> bool:
        """
