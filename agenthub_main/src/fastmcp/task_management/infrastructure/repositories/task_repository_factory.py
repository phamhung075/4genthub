...
class TaskRepositoryFactory:
    ...
    def __init__(
        ...
        self.base_path = base_path or str(
            self.project_root / ".cursor" / "rules" / "tasks"
        )

        # Handle default_user_id - NO FALLBACKS ALLOWED
        if default_user_id is not None:
            # Validate if a user_id was provided
            default_user_id = validate_user_id(
                default_user_id, "Task repository factory initialization"
            )
    ...
    def create_repository(
        self, project_id: str, git_branch_name: str = "main", user_id: str | None = None
    ) -> TaskRepository:
        """
    ...
    def create_repository_with_git_branch_id(
    ...
    def create_sqlite_task_repository(
        self,
        project_id: str,
        git_branch_name: str = "main",
