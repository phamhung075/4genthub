...
class ContextTemplate:
    ...
    created_at: datetime | None = (
        None  # Template metadata - will be set when template is registered
    )
        ...
        self.register(
            ContextTemplate(
                ...
                data_template={
                    ...
                    "documentation": {"openapi": "Auto-generated", "redoc": "Enabled"},
                    "deployment": {
...
class ContextTemplateService:
    ...
    def _apply_variables(
        self, template: ContextTemplate, variables: dict[str, Any]
    ) -> dict[str, Any]:
