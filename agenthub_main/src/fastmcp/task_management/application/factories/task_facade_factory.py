...
class TaskFacadeFactory:
    ...
    def create_task_facade(
        ...
        if project_id is None:
            ...
            task_repository = self._repository_provider.get_task_repository(
                project_id=None, git_branch_name=None, user_id=user_id
            )
        else:
            # Create task repository for facade construction
            # Repository provider handles the details
            task_repository = self._repository_provider.get_task_repository(
                project_id=project_id, git_branch_name=None, user_id=user_id
            )
        ...
        git_branch_repository = self._repository_provider.get_git_branch_repository(
            user_id=user_id
        )
    ...
    def create_task_facade_with_git_branch_id(
        self, project_id: str, git_branch_name: str, user_id: str, git_branch_id: str
    ) -> object:
        """
        ...
        task_repository = self._repository_provider.get_task_repository(
            project_id=project_id, git_branch_name=git_branch_name, user_id=user_id
        )
