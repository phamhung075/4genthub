...
class FacadeService:
    ...
    def get_task_facade(
        ...
        return factory.create_task_facade(
            project_id=project_id, git_branch_id=git_branch_id, user_id=user_id
        )

    def get_subtask_facade(
        self,
        project_id: str | None = None,
        git_branch_id: str | None = None,
        user_id: str | None = None,
    ...
    def get_project_facade(self, user_id: str | None = None):
        """
    ...
    def get_branch_facade(
        ...
        return factory.create_facade(project_id=project_id, user_id=user_id)
    ...
    def get_agent_facade(
        ...
        return factory.create_agent_facade(project_id=project_id, user_id=user_id)
    ...
    def get_context_facade(
        ...
        return factory.create_facade(
            user_id=user_id, project_id=project_id, git_branch_id=git_branch_id
        )

    def get_token_facade(self, user_id: str | None = None):
        """
    ...
    @classmethod
    def get_unified_context_facade(
        cls,
        user_id: str | None = None,
        project_id: str | None = None,
        git_branch_id: str | None = None,
