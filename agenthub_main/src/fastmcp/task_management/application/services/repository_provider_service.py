...
class RepositoryProviderService:
    ...
    def get_subtask_repository(
        ...
        return factory.create_subtask_repository(
            project_id, git_branch_name or "main", user_id
        )

    def get_project_repository(
        self, user_id: str | None = None, session: Session | None = None
    ) -> ProjectRepository:
        """
    ...
    def get_git_branch_repository(
        self, session: Session | None = None, user_id: str | None = None
    ) -> GitBranchRepository:
        """
    ...
    def get_global_context_repository(
    ...
    def get_project_context_repository(
        self, session: Session | None = None
    ) -> ContextRepository:
        """
    ...
    def get_branch_context_repository(
        self, session: Session | None = None
    ) -> ContextRepository:
        """
    ...
    def get_task_context_repository(
        self, session: Session | None = None
    ) -> ContextRepository:
        """
