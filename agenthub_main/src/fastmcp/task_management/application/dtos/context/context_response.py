...
class ContextResponse:
    ...
    def success_response(
        ...
        return cls(success=True, message=message, data=data, context=context)

    @classmethod
    def error_response(
        cls, error: str, message: str = "Operation failed"
    ) -> ContextResponse:
...
class ListContextsResponse(ContextResponse):
    ...
    def success_response(
        ...
        message: str = "Contexts retrieved successfully",
    ) -> ListContextsResponse:
        """Create a success response with contexts"""
        return cls(success=True, message=message, contexts=contexts)
...
class GetPropertyResponse(ContextResponse):
    ...
    @classmethod
    def success_response(
        cls, value: Any, message: str = "Property retrieved successfully"
    ) -> GetPropertyResponse:
