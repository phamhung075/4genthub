...
class DependencyApplicationFacade:
    ...
    def manage_dependencies(
        self, action: str, task_id: str, dependency_data: dict[str, Any] = None
    ) -> dict[str, Any]:
        ...
        try:
            ...
            if action == "add_dependency":
                ...
                request = AddDependencyRequest(
                    task_id=task_id, depends_on_task_id=dependency_data["dependency_id"]
                )
                ...
                if not dependency_data or "dependency_id" not in dependency_data:
                    raise ValueError("dependency_data with dependency_id is required")
                response = self._dependency_app_service.remove_dependency(
