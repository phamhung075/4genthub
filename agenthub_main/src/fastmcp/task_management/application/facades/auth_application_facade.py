...
class AuthApplicationFacade:
    ...
    def __init__(self, session: Session):
        ...
        self.auth_service = AuthService(
            user_repository=user_repository, jwt_service=self.jwt_service
        )
        ...
        try:
            ...
            if payload:
                ...
                if user_id:
                    ...
                    if user:
                        logger.info(
                            f"✅ Authenticated via JWT: {user.email if hasattr(user, 'email') else user_id}"
                        )
                        return user
                    else:
            ...
            try:
                ...
                if supabase:
                    ...
                    if user_data and user_data.user:
                        ...
                        user = self.auth_service.find_or_create_from_supabase(
                            user_data.user
                        )
                        if user:
