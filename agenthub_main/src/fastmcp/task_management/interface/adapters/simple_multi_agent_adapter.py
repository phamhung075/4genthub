...
class SimpleMultiAgentAdapter:
    ...
    def __init__(
        ...
        self._project_service = project_service or ProjectManagementService(
            self._path_resolver, projects_file_path
        )
    ...
    def assign_agent_to_tree(
        ...
        return self._project_service.assign_agent_to_tree(
