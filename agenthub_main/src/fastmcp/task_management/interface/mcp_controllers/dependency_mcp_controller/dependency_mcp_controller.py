...
from .manage_dependency_description import (
    get_manage_dependency_description,
    get_manage_dependency_parameters,
)
...
class DependencyMCPController:
    ...
    def register_tools(self, mcp: FastMCP):
        ...
        def manage_dependency(
            ...
            dependency_data: Annotated[
                str, Field(description=params["dependency_data"]["description"])
            ] = None,
        ) -> dict[str, Any]:
    ...
    def handle_dependency_operations(
        self,
        action: str,
        ...
        try:
            ...
            git_branch_name = (
                coerced_params.get("git_branch_name", git_branch_name) or "main"
            )
