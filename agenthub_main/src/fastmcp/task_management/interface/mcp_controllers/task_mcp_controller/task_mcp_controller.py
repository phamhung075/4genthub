...
class TaskMCPController(ContextPropagationMixin):
    ...
    def register_tools(self, mcp: "FastMCP"):
        ...
        async def manage_task(
            ...
            dependencies: Annotated[Union[str, List[str]], Field(description="[OPTIONAL] " + params["dependencies"]["description"])] = None,
        ...
        if action == "create":
            ...
            if not kwargs.get('git_branch_id'):
                return False, self._response_formatter.create_error_response(
                    ...
                    error_code="VALIDATION_ERROR",
                    metadata={"hint": "Use 'next' action to get recommended tasks for a specific branch"}
                )
            return True, None
        else:
