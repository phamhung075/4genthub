...
from .....application.use_cases.ai_task_creation_use_case import (
    AITaskCreationRequest,
    AITaskCreationUseCase,
)
...
class AIHandler:
    ...
    async def ai_enhance(self, facade, **kwargs) -> dict[str, Any]:
        ...
        try:
            ...
            result = await ai_use_case.enhance_existing_task(
                task_id, enhancement_options
            )
    ...
    async def ai_suggest_agents(self, facade, **kwargs) -> dict[str, Any]:
        ...
        try:
            ...
            if available_agents:
                available_list = [
                    agent.strip() for agent in available_agents.split(",")
                ]
            ...
            suggestion_result = {
                ...
                "specialization_needs": self._identify_specialization_needs(
                    insights.get("pattern_distribution", {})
                ),
            }
