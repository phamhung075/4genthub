...
MANAGE_SUBTASK_PARAMETERS_DESCRIPTION = {
    ...
    "task_id": "Parent task identifier (UUID). Required for all actions",
    "subtask_id": "Subtask identifier (UUID). Required for update, delete, get, complete actions",
    "title": "Subtask title. Required for create, optional for update",
    "description": "Detailed subtask description explaining what needs to be done. Include acceptance criteria if relevant",
    "status": "Subtask status: 'todo', 'in_progress', 'done'. Note: use progress_percentage instead for automatic status mapping",
    ...
    "skills_learned": "New skills or knowledge gained. Comma-separated string or JSON array",
    "next_recommendations": "Suggestions for future work. Comma-separated string or JSON array",
    "deliverables": "Artifacts or outputs created. Comma-separated string or JSON array",
    "completion_quality": "Quality assessment of work completed. Example: 'Production-ready', 'Requires review', 'Prototype only'",
    "blockers": "Issues preventing progress. Comma-separated string or JSON array. Example: 'Missing API documentation,Waiting for database schema approval'",
    "impact_on_parent": "How completing this subtask affects the parent task. Required for complete action",
