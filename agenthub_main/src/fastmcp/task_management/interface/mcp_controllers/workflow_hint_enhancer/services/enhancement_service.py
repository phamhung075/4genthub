...
class EnhancementService:
    ...
    def enhance_response(
        self, response: dict[str, Any], operation_context: dict[str, Any] | None = None
    ) -> dict[str, Any]:
    ...
    def add_task_hints(
        self, response: dict[str, Any], task_data: dict[str, Any] | None = None
    ) -> dict[str, Any]:
        ...
        if task_data:
            ...
            enhanced["workflow_hints"]["task_guidance"] = self._generate_task_guidance(
                state, task_data
            )
            enhanced["workflow_hints"]["next_actions"] = self._suggest_next_actions(
                state, task_data
            )
        else:
    ...
    def add_context_hints(
        self, response: dict[str, Any], context_level: str | None = None
    ) -> dict[str, Any]:
    ...
    def _enhance_error_response(
        self, response: dict[str, Any], action: str, request_params: dict[str, Any]
    ) -> dict[str, Any]:
    ...
    def _extract_task_context(
        self, response: dict[str, Any], request_params: dict[str, Any]
    ) -> dict[str, Any] | None:
    ...
    def _generate_workflow_guidance(
        self, task_context: dict[str, Any], action: str, request_params: dict[str, Any]
    ) -> dict[str, Any]:
    ...
    def _get_level_specific_guidance(self, level: str | None) -> list[str]:
    ...
    def _get_error_prevention_tips(
        self, response: dict[str, Any], action: str
    ) -> list[str]:
