...
class AgentOperationFactory:
    ...
    def handle_operation(
        self, operation: str, facade: AgentApplicationFacade, **kwargs
    ) -> dict[str, Any]:
    ...
    def _handle_crud_operation(
        ...
        if operation == "register":
            ...
            return self._crud_handler.list_agents(facade=facade, project_id=project_id)
    ...
    def _handle_rebalance_operation(
        self, operation: str, facade: AgentApplicationFacade, **kwargs
    ) -> dict[str, Any]:
        ...
        if operation == "rebalance":
            return self._rebalance_handler.rebalance_agents(
                facade=facade, project_id=project_id
            )
