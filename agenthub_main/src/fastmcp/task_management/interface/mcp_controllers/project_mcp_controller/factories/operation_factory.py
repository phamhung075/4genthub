...
class ProjectOperationFactory:
    ...
    async def handle_operation(
        self, operation: str, facade: ProjectApplicationFacade, **kwargs
    ) -> dict[str, Any]:
        ...
        try:
            ...
            # Maintenance Operations
                ...
                return await self._handle_maintenance_operation(
    ...
    async def _handle_maintenance_operation(
        self, operation: str, facade: ProjectApplicationFacade, **kwargs
    ) -> dict[str, Any]:
        ...
        if operation == "project_health_check":
            return await self._maintenance_handler.project_health_check(
                facade=facade, project_id=project_id, user_id=user_id
            )

        elif operation == "cleanup_obsolete":
            return await self._maintenance_handler.cleanup_obsolete(
                facade=facade, project_id=project_id, force=force, user_id=user_id
            )
