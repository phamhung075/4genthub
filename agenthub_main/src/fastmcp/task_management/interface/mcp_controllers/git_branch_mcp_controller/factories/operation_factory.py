...
class GitBranchOperationFactory:
    ...
    def handle_operation(
        self, operation: str, facade: GitBranchApplicationFacade, **kwargs
    ) -> dict[str, Any]:
        ...
        try:
            ...
            logger.error(
                f"Error in GitBranchOperationFactory.handle_operation: {str(e)}"
            )
            return self._response_formatter.create_error_response(
                operation=operation,
    ...
    def _handle_crud_operation(
        ...
        if operation == "create":
            ...
            return self._crud_handler.list_git_branches(
                facade=facade, project_id=kwargs.get("project_id")
            )
    ...
    def _handle_advanced_operation(
        self, operation: str, facade: GitBranchApplicationFacade, **kwargs
    ) -> dict[str, Any]:
