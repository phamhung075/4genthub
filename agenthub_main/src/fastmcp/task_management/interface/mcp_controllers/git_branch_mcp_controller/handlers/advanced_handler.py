...
class GitBranchAdvancedHandler:
    ...
    def get_statistics(
        self, facade: GitBranchApplicationFacade, project_id: str, git_branch_id: str
    ) -> dict[str, Any]:
        """Get statistics for a git branch."""

        try:
            result = facade.get_statistics(
                project_id=project_id, git_branch_id=git_branch_id
            )
            ...
            return self._response_formatter.create_error_response(
                ...
                metadata={"project_id": project_id, "git_branch_id": git_branch_id},
            )

    def archive_git_branch(
        self, facade: GitBranchApplicationFacade, project_id: str, git_branch_id: str
    ) -> dict[str, Any]:
