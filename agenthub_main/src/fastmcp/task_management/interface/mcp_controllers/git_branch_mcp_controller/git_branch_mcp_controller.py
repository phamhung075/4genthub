...
from ..workflow_guidance.git_branch.git_branch_workflow_factory import (
    GitBranchWorkflowFactory,
)
...
from .manage_git_branch_description import (
    get_manage_git_branch_description,
    get_manage_git_branch_parameters,
)
...
class GitBranchMCPController(ContextPropagationMixin):
    ...
    def manage_git_branch(
        ...
        try:
            ...
            user_id = get_authenticated_user_id(
                provided_user_id=user_id, operation_name=f"manage_git_branch:{action}"
            )
            ...
            if not project_id:
                return self._response_formatter.create_error_response(
                    ...
                    metadata={
                        "field": "project_id",
                        "hint": "Include 'project_id' in your request",
                    },
                )
            ...
            result = self._operation_factory.handle_operation(
                operation=action, facade=facade, **kwargs
            )
    ...
    def _get_facade_for_request(
        ...
        return self._facade_service.get_branch_facade(
