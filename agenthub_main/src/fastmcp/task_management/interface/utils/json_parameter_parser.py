...
class JSONParameterParser:
    ...
    def parse_dict_parameter(
        param_value: str | dict[str, Any] | None, param_name: str = "parameter"
    ) -> dict[str, Any] | None:
        """
    ...
    def parse_multiple_dict_parameters(
        parameters: dict[str, Any], dict_param_names: list[str]
    ) -> dict[str, Any]:
        """
                ...
                try:
                    parsed_params[param_name] = (
                        JSONParameterParser.parse_dict_parameter(
                            parsed_params[param_name], param_name
                        )
                    )
    ...
    def create_error_response(
        param_name: str, error_message: str, tool_name: str = "manage_tool"
    ) -> dict[str, Any]:
        """
