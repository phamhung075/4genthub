...
class ConnectionStatusBroadcaster:
    ...
    async def _create_status_update(self, event_type: str) -> StatusUpdate:
        ...
        if self.connection_manager:
            try:
                ...
                reconnection_info = (
                    await self.connection_manager.get_reconnection_info()
                )
    ...
    async def _broadcast_to_all_clients(
        self, status_update: StatusUpdate, immediate: bool = False
    ):
        ...
        {"type": "status_update", "data": asdict(status_update)}
...
async def get_status_broadcaster(
