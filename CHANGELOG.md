...
- **Docker Menu Help Page - Detailed Descriptions** (2025-10-16): Enhanced all 16 menu option descriptions in `/help` page with comprehensive details. Updated `DockerSetup.tsx` (lines 13-28) with detailed explanations for each option including ports, prerequisites, use cases, and technical details. Examples: Option 1 now shows "Start backend (port 8000) and frontend (port 3800). Requires database already running (option B)." Option B shows "Start PostgreSQL 18 database only (port 5432). Run this first before option 1." All descriptions now provide actionable guidance for developers
